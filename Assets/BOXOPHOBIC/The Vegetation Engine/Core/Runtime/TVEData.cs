...
namespace TheVegetationEngine
{
    ...
    public enum TVETerrainLayersMode
    {
        _4Layers = 4,
        _8Layers = 8,
        _12Layers = 12,
    ...
    public enum TVETerrainMapsMode
    {
        Default = 0,
        Packed = 10,
    }
    ...
    [System.Serializable]
    public class TVETerrainSplatData
    {
        [HideInInspector]
        public string name = "";
        [HideInInspector]
    ...
    [System.Serializable]
    public class TVETerrainLayerData
    {
        [HideInInspector]
        public string name = "";
        [HideInInspector]
        ...
        [Space(10)]
        public Vector4 maskRemapMin = Vector4.zero;
        public Vector4 maskRemapMax = Vector4.one;
        public Vector4 textureCoords = new Vector4(1, 1, 0, 0);
