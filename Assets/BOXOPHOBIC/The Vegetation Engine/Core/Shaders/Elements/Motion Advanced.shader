...
#define _ElementParams_arr BOXOPHOBICTheVegetationEngineElementsMotionAdvanced
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float3 appendResult1436_g25297 = (float3(lerpResult1435_g25297 , Motion_Power1000_g25297));
...
ASEEND*/
//CHKSM=83029B9D059B94A0AD68C489E2A09D4254A360C8