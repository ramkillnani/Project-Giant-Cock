	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float Terrain_Height175 = tex2D( _MainTex, ( ( 1.0 - i.ase_texcoord1.xy ) + ( appendResult196 * 0.5 ) ) ).r;
				float Terrain_SizeY143 = _TerrainSize.y;
				float Terrain_Height_Raw206 = ( Terrain_Height175 * Terrain_SizeY143 * 2.0 );
				...
				float4 appendResult169 = (float4(0.0 , 0.0 , ( Terrain_Height_Raw206 + Terrain_PosY200 + _HeightOffsetValue ) , Element_Alpha182));
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float Terrain_SizeY143 = _TerrainSize.y;
				float Terrain_Height_Raw206 = ( Terrain_Height175 * Terrain_SizeY143 * 2.0 );
				float3 temp_cast_1 = (saturate( ( Terrain_Height_Raw206 * 0.1 ) )).xxx;
...
/*ASEBEGIN
Version=19202
Node;AmplifyShaderEditor.RegisterLocalVarNode;182;-1024,128;Half;False;Element_Alpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;175;-1024,-512;Inherit;False;Terrain_Height;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;208;-256,-128;Inherit;False;206;Terrain_Height_Raw;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;176;-256,-896;Inherit;False;175;Terrain_Height;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;207;-256,-512;Inherit;False;206;Terrain_Height_Raw;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;206;512,-896;Inherit;False;Terrain_Height_Raw;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;136;-2176,128;Inherit;False;Element Base Vertex;1;;21545;9f8670cd8fdc98444822270656343d82;0;0;1;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;174;-2176,192;Inherit;False;Element Fade Volume;17;;21547;4935729172cdadd45b9b14c3fa9c1db4;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=12E5CA01F7E9EF7E15776CD7D6A1C1C622A959D4