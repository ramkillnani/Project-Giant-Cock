...
Shader "BOXOPHOBIC/The Vegetation Engine/Geometry/Plant Subsurface Lit"
{
	Properties
	{
		...
		[Space(10)][StyledToggle]_ColorsMaskMode("Use Inverted Alpha for Colors", Float) = 0
		...
		[HideInInspector]_IsVersion("_IsVersion", Float) = 1201
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half3 VertexPos40_g77175 = temp_output_2283_0_g77092;
				half3 VertexPos40_g77176 = VertexPos40_g77175;
				float3 appendResult74_g77176 = (float3(VertexPos40_g77176.x , 0.0 , 0.0));
				half3 VertexPosRotationAxis50_g77176 = appendResult74_g77176;
				float3 break84_g77176 = VertexPos40_g77176;
				float3 appendResult81_g77176 = (float3(0.0 , break84_g77176.y , break84_g77176.z));
				half3 VertexPosOtherAxis82_g77176 = appendResult81_g77176;
				...
				float4x4 break19_g77150 = GetObjectToWorldMatrix();
				float3 appendResult20_g77150 = (float3(break19_g77150[ 0 ][ 3 ] , break19_g77150[ 1 ][ 3 ] , break19_g77150[ 2 ][ 3 ]));
				float3 temp_output_122_0_g77150 = Mesh_PivotsData2831_g77092;
				float3 PivotsOnly105_g77150 = (mul( GetObjectToWorldMatrix(), float4( temp_output_122_0_g77150 , 0.0 ) ).xyz).xyz;
				half3 ObjectData20_g77152 = ( appendResult20_g77150 + PivotsOnly105_g77150 );
				half3 WorldData19_g77152 = ase_worldPos;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g77152 = WorldData19_g77152;
				#else
				float3 staticSwitch14_g77152 = ObjectData20_g77152;
				#endif
				float3 temp_output_114_0_g77150 = staticSwitch14_g77152;
				float3 vertexToFrag4224_g77092 = temp_output_114_0_g77150;
				...
				half3 Input_Position419_g77190 = Motion_10_Position6738_g77092;
				float Input_MotionScale287_g77190 = ( _MotionScale_10 + 0.2 );
				half NoiseTex_Tilling735_g77190 = TVE_NoiseTexTilling;
				float2 temp_output_597_0_g77190 = (( Input_Position419_g77190 * Input_MotionScale287_g77190 * NoiseTex_Tilling735_g77190 * 0.0075 )).xz;
				...
				half2 Input_DirectionWS423_g77190 = Global_Wind_DirectionWS4683_g77092;
				float lerpResult128_g77191 = lerp( _TimeParameters.x , ( ( _TimeParameters.x * TVE_TimeParams.x ) + TVE_TimeParams.y ) , TVE_TimeParams.w);
				half Input_MotionSpeed62_g77190 = _MotionSpeed_10;
				half Input_MotionVariation284_g77190 = _MotionVariation_10;
				half3 Input_Position167_g77207 = ObjectPosition_Shifted7481_g77092;
				float dotResult156_g77207 = dot( (Input_Position167_g77207).xz , float2( 12.9898,78.233 ) );
				half Vertex_DynamicMode5112_g77092 = _VertexDynamicMode;
				half Input_DynamicMode120_g77207 = Vertex_DynamicMode5112_g77092;
				float Postion_Random162_g77207 = ( sin( dotResult156_g77207 ) * ( 1.0 - Input_DynamicMode120_g77207 ) );
				float Mesh_Variation16_g77092 = v.ase_color.r;
				half Input_Variation124_g77207 = Mesh_Variation16_g77092;
				half ObjectData20_g77209 = frac( ( Postion_Random162_g77207 + Input_Variation124_g77207 ) );
				half WorldData19_g77209 = Input_Variation124_g77207;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g77209 = WorldData19_g77209;
				#else
				float staticSwitch14_g77209 = ObjectData20_g77209;
				#endif
				float temp_output_112_0_g77207 = staticSwitch14_g77209;
				float clampResult171_g77207 = clamp( temp_output_112_0_g77207 , 0.01 , 0.99 );
				float Global_MeshVariation5104_g77092 = clampResult171_g77207;
				half Input_GlobalMeshVariation569_g77190 = Global_MeshVariation5104_g77092;
				float temp_output_630_0_g77190 = ( ( ( lerpResult128_g77191 * Input_MotionSpeed62_g77190 ) + ( Input_MotionVariation284_g77190 * Input_GlobalMeshVariation569_g77190 ) ) * 0.03 );
				float temp_output_607_0_g77190 = frac( temp_output_630_0_g77190 );
				float4 lerpResult590_g77190 = lerp( SAMPLE_TEXTURE2D_LOD( TVE_NoiseTex, sampler_Linear_Repeat, ( temp_output_597_0_g77190 + ( -Input_DirectionWS423_g77190 * temp_output_607_0_g77190 ) ), 0.0 ) , SAMPLE_TEXTURE2D_LOD( TVE_NoiseTex, sampler_Linear_Repeat, ( temp_output_597_0_g77190 + ( -Input_DirectionWS423_g77190 * frac( ( temp_output_630_0_g77190 + 0.5 ) ) ) ), 0.0 ) , ( abs( ( temp_output_607_0_g77190 - 0.5 ) ) / 0.5 ));
				half4 Noise_Complex703_g77190 = lerpResult590_g77190;
				float2 temp_output_645_0_g77190 = ((Noise_Complex703_g77190).rg*2.0 + -1.0);
				float2 break650_g77190 = temp_output_645_0_g77190;
				float3 appendResult649_g77190 = (float3(break650_g77190.x , 0.0 , break650_g77190.y));
				float3 ase_parentObjectScale = ( 1.0 / float3( length( GetWorldToObjectMatrix()[ 0 ].xyz ), length( GetWorldToObjectMatrix()[ 1 ].xyz ), length( GetWorldToObjectMatrix()[ 2 ].xyz ) ) );
				half2 Global_Noise_OS5548_g77092 = (( mul( GetWorldToObjectMatrix(), float4( appendResult649_g77190 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_Noise_DirectionOS487_g77181 = Global_Noise_OS5548_g77092;
				...
				half2 Input_Wind_DirectionOS458_g77181 = Global_Wind_DirectionOS5692_g77092;
				float temp_output_84_0_g77105 = _LayerMotionValue;
				float temp_output_19_0_g77109 = TVE_MotionUsage[(int)temp_output_84_0_g77105];
				float4 temp_output_91_19_g77105 = TVE_MotionCoords;
				half2 UV94_g77105 = ( (temp_output_91_19_g77105).zw + ( (temp_output_91_19_g77105).xy * (ObjectPosition4223_g77092).xz ) );
				float4 tex2DArrayNode50_g77105 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_MotionTex, sampler_Linear_Clamp, UV94_g77105,temp_output_84_0_g77105, 0.0 );
				float4 temp_output_17_0_g77109 = tex2DArrayNode50_g77105;
				float4 temp_output_112_19_g77105 = TVE_MotionParams;
				float4 temp_output_3_0_g77109 = temp_output_112_19_g77105;
				float4 ifLocalVar18_g77109 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g77109 >= 0.5 )
				ifLocalVar18_g77109 = temp_output_17_0_g77109;
				else
				ifLocalVar18_g77109 = temp_output_3_0_g77109;
				float4 lerpResult22_g77109 = lerp( temp_output_3_0_g77109 , temp_output_17_0_g77109 , temp_output_19_0_g77109);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g77109 = lerpResult22_g77109;
				#else
				float4 staticSwitch24_g77109 = ifLocalVar18_g77109;
				#endif
				half4 Global_Motion_Params3909_g77092 = staticSwitch24_g77109;
				...
				half Input_WindPower449_g77181 = Global_Wind_Power2223_g77092;
				float2 lerpResult516_g77181 = lerp( Input_Noise_DirectionOS487_g77181 , Input_Wind_DirectionOS458_g77181 , ( Input_WindPower449_g77181 * 0.6 ));
				half Mesh_Motion_107572_g77092 = v.ase_color.a;
				half Input_MeshHeight388_g77181 = Mesh_Motion_107572_g77092;
				half ObjectData20_g77182 = Input_MeshHeight388_g77181;
				float enc62_g77214 = v.texcoord.w;
				float2 localDecodeFloatToVector262_g77214 = DecodeFloatToVector2( enc62_g77214 );
				float2 break63_g77214 = ( localDecodeFloatToVector262_g77214 * 100.0 );
				float Bounds_Height5230_g77092 = break63_g77214.x;
				half Input_BoundsHeight390_g77181 = Bounds_Height5230_g77092;
				half WorldData19_g77182 = ( Input_MeshHeight388_g77181 * Input_MeshHeight388_g77181 * Input_BoundsHeight390_g77181 );
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g77182 = WorldData19_g77182;
				#else
				float staticSwitch14_g77182 = ObjectData20_g77182;
				#endif
				half Final_Motion10_Mask321_g77181 = ( staticSwitch14_g77182 * 2.0 );
				half Input_BendingAmplitude376_g77181 = _MotionAmplitude_10;
				half Global_MotionValue640_g77181 = TVE_MotionValue_10;
				half2 Final_Bending631_g77181 = ( lerpResult516_g77181 * ( Final_Motion10_Mask321_g77181 * Input_BendingAmplitude376_g77181 * Input_WindPower449_g77181 * Input_WindPower449_g77181 * Global_MotionValue640_g77181 ) );
				...
				half2 Input_React_DirectionOS358_g77181 = Global_React_DirectionOS39_g77092;
				float clampResult17_g77184 = clamp( Input_MeshHeight388_g77181 , 0.0001 , 0.9999 );
				float temp_output_7_0_g77183 = 0.0;
				half Input_InteractionUseMask62_g77181 = _InteractionMaskValue;
				float temp_output_10_0_g77183 = ( Input_InteractionUseMask62_g77181 - temp_output_7_0_g77183 );
				half Final_InteractionRemap594_g77181 = saturate( ( ( clampResult17_g77184 - temp_output_7_0_g77183 ) / ( temp_output_10_0_g77183 + 0.0001 ) ) );
				half ObjectData20_g77185 = Final_InteractionRemap594_g77181;
				half WorldData19_g77185 = ( Final_InteractionRemap594_g77181 * Final_InteractionRemap594_g77181 * Input_BoundsHeight390_g77181 );
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g77185 = WorldData19_g77185;
				#else
				float staticSwitch14_g77185 = ObjectData20_g77185;
				#endif
				half Final_InteractionMask373_g77181 = ( staticSwitch14_g77185 * 2.0 );
				half Input_InteractionAmplitude58_g77181 = _InteractionAmplitude;
				half2 Final_Interaction632_g77181 = ( Input_React_DirectionOS358_g77181 * Final_InteractionMask373_g77181 * Input_InteractionAmplitude58_g77181 );
				half Global_Interaction_Mask66_g77092 = ( break322_g77097.w * break322_g77097.w * break322_g77097.w * break322_g77097.w );
				float Input_InteractionGlobalMask330_g77181 = Global_Interaction_Mask66_g77092;
				half Final_InteractionValue525_g77181 = saturate( ( Input_InteractionAmplitude58_g77181 * Input_InteractionGlobalMask330_g77181 ) );
				float2 lerpResult551_g77181 = lerp( Final_Bending631_g77181 , Final_Interaction632_g77181 , Final_InteractionValue525_g77181);
				float2 break364_g77181 = lerpResult551_g77181;
				float3 appendResult638_g77181 = (float3(break364_g77181.x , 0.0 , break364_g77181.y));
				half3 Motion_10_Interaction7519_g77092 = appendResult638_g77181;
				half3 Angle44_g77175 = Motion_10_Interaction7519_g77092;
				half Angle44_g77176 = (Angle44_g77175).z;
				half3 VertexPos40_g77177 = ( VertexPosRotationAxis50_g77176 + ( VertexPosOtherAxis82_g77176 * cos( Angle44_g77176 ) ) + ( cross( float3(1,0,0) , VertexPosOtherAxis82_g77176 ) * sin( Angle44_g77176 ) ) );
				float3 appendResult74_g77177 = (float3(0.0 , 0.0 , VertexPos40_g77177.z));
				half3 VertexPosRotationAxis50_g77177 = appendResult74_g77177;
				float3 break84_g77177 = VertexPos40_g77177;
				float3 appendResult81_g77177 = (float3(break84_g77177.x , break84_g77177.y , 0.0));
				half3 VertexPosOtherAxis82_g77177 = appendResult81_g77177;
				half Angle44_g77177 = -(Angle44_g77175).x;
				half3 Input_Position419_g77205 = WorldPosition_Shifted7477_g77092;
				float3 break459_g77205 = Input_Position419_g77205;
				float Sum_Position446_g77205 = ( break459_g77205.x + break459_g77205.y + break459_g77205.z );
				half Input_MotionScale321_g77205 = ( _MotionScale_20 * 0.1 );
				half Input_MotionVariation330_g77205 = _MotionVariation_20;
				half Input_GlobalVariation400_g77205 = Global_MeshVariation5104_g77092;
				float lerpResult128_g77206 = lerp( _TimeParameters.x , ( ( _TimeParameters.x * TVE_TimeParams.x ) + TVE_TimeParams.y ) , TVE_TimeParams.w);
				half Input_MotionSpeed62_g77205 = _MotionSpeed_20;
				float temp_output_404_0_g77205 = ( lerpResult128_g77206 * Input_MotionSpeed62_g77205 );
				half Motion_SineA450_g77205 = sin( ( ( Sum_Position446_g77205 * Input_MotionScale321_g77205 ) + ( Input_MotionVariation330_g77205 * Input_GlobalVariation400_g77205 ) + temp_output_404_0_g77205 ) );
				half Motion_SineB395_g77205 = sin( ( ( temp_output_404_0_g77205 * 0.6842 ) + ( Sum_Position446_g77205 * Input_MotionScale321_g77205 ) ) );
				half3 Input_Position419_g77103 = VertexPosition3588_g77092;
				float3 normalizeResult518_g77103 = normalize( Input_Position419_g77103 );
				half2 Input_DirectionOS423_g77103 = Global_React_DirectionOS39_g77092;
				float2 break521_g77103 = -Input_DirectionOS423_g77103;
				float3 appendResult522_g77103 = (float3(break521_g77103.x , 0.0 , break521_g77103.y));
				float dotResult519_g77103 = dot( normalizeResult518_g77103 , appendResult522_g77103 );
				half Input_Value62_g77103 = _MotionFacingValue;
				float lerpResult524_g77103 = lerp( 1.0 , (dotResult519_g77103*0.5 + 0.5) , Input_Value62_g77103);
				half ObjectData20_g77104 = max( lerpResult524_g77103 , 0.001 );
				half WorldData19_g77104 = 1.0;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g77104 = WorldData19_g77104;
				#else
				float staticSwitch14_g77104 = ObjectData20_g77104;
				#endif
				half Motion_FacingMask5214_g77092 = staticSwitch14_g77104;
				half Motion_20_Amplitude4381_g77092 = Motion_FacingMask5214_g77092;
				half Input_MotionAmplitude384_g77205 = Motion_20_Amplitude4381_g77092;
				half Input_GlobalWind407_g77205 = Global_Wind_Power2223_g77092;
				float4 break638_g77190 = abs( Noise_Complex703_g77190 );
				half Global_Noise_B5526_g77092 = break638_g77190.b;
				half Input_GlobalNoise411_g77205 = Global_Noise_B5526_g77092;
				float lerpResult413_g77205 = lerp( 1.8 , 0.4 , Input_GlobalWind407_g77205);
				half Motion_Amplitude418_g77205 = ( Input_MotionAmplitude384_g77205 * Input_GlobalWind407_g77205 * pow( Input_GlobalNoise411_g77205 , lerpResult413_g77205 ) );
				half Input_Squash58_g77205 = _MotionAmplitude_20;
				float enc59_g77214 = v.texcoord.z;
				float2 localDecodeFloatToVector259_g77214 = DecodeFloatToVector2( enc59_g77214 );
				float2 break61_g77214 = localDecodeFloatToVector259_g77214;
				half Mesh_Motion_2060_g77092 = break61_g77214.x;
				half Input_MeshMotion_20388_g77205 = Mesh_Motion_2060_g77092;
				float Bounds_Radius5231_g77092 = break63_g77214.y;
				half Input_BoundsRadius390_g77205 = Bounds_Radius5231_g77092;
				half Global_MotionValue462_g77205 = TVE_MotionValue_20;
				half2 Input_DirectionOS366_g77205 = Global_React_DirectionOS39_g77092;
				float2 break371_g77205 = Input_DirectionOS366_g77205;
				float3 appendResult372_g77205 = (float3(break371_g77205.x , ( Motion_SineA450_g77205 * 0.3 ) , break371_g77205.y));
				half3 Motion_20_Squash4418_g77092 = ( ( (max( Motion_SineA450_g77205 , Motion_SineB395_g77205 )*0.5 + 0.5) * Motion_Amplitude418_g77205 * Input_Squash58_g77205 * Input_MeshMotion_20388_g77205 * Input_BoundsRadius390_g77205 * Global_MotionValue462_g77205 ) * appendResult372_g77205 );
				half3 VertexPos40_g77168 = ( ( VertexPosRotationAxis50_g77177 + ( VertexPosOtherAxis82_g77177 * cos( Angle44_g77177 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g77177 ) * sin( Angle44_g77177 ) ) ) + Motion_20_Squash4418_g77092 );
				float3 appendResult74_g77168 = (float3(0.0 , VertexPos40_g77168.y , 0.0));
				float3 VertexPosRotationAxis50_g77168 = appendResult74_g77168;
				float3 break84_g77168 = VertexPos40_g77168;
				float3 appendResult81_g77168 = (float3(break84_g77168.x , 0.0 , break84_g77168.z));
				float3 VertexPosOtherAxis82_g77168 = appendResult81_g77168;
				half Input_Rolling379_g77205 = _MotionAmplitude_22;
				half Motion_20_Rolling5257_g77092 = ( Motion_SineA450_g77205 * Motion_Amplitude418_g77205 * Input_Rolling379_g77205 * Input_MeshMotion_20388_g77205 * Global_MotionValue462_g77205 );
				half Angle44_g77168 = Motion_20_Rolling5257_g77092;
				half3 Input_Position500_g77186 = WorldPosition_Shifted7477_g77092;
				half Input_MotionScale321_g77186 = _MotionScale_32;
				half Input_MotionVariation330_g77186 = _MotionVariation_32;
				half Input_GlobalVariation372_g77186 = Global_MeshVariation5104_g77092;
				float lerpResult128_g77187 = lerp( _TimeParameters.x , ( ( _TimeParameters.x * TVE_TimeParams.x ) + TVE_TimeParams.y ) , TVE_TimeParams.w);
				half Input_MotionSpeed62_g77186 = _MotionSpeed_32;
				float4 tex2DNode460_g77186 = SAMPLE_TEXTURE2D_LOD( TVE_NoiseTex, sampler_Linear_Repeat, ( ( (Input_Position500_g77186).xz * Input_MotionScale321_g77186 * 0.03 ) + ( Input_MotionVariation330_g77186 * Input_GlobalVariation372_g77186 ) + ( lerpResult128_g77187 * Input_MotionSpeed62_g77186 * 0.02 ) ), 0.0 );
				float3 appendResult462_g77186 = (float3(tex2DNode460_g77186.r , tex2DNode460_g77186.g , tex2DNode460_g77186.b));
				half3 Flutter_Texture489_g77186 = (appendResult462_g77186*2.0 + -1.0);
				float temp_output_7_0_g77144 = TVE_MotionFadeEnd;
				float temp_output_10_0_g77144 = ( TVE_MotionFadeStart - temp_output_7_0_g77144 );
				half Motion_FadeOut4005_g77092 = saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g77144 ) / ( temp_output_10_0_g77144 + 0.0001 ) ) );
				half Motion_30_Amplitude4960_g77092 = ( _MotionAmplitude_32 * Motion_FacingMask5214_g77092 * Motion_FadeOut4005_g77092 );
				half Input_MotionAmplitude58_g77186 = Motion_30_Amplitude4960_g77092;
				half Mesh_Motion_30144_g77092 = break61_g77214.y;
				half Input_MeshMotion_30374_g77186 = Mesh_Motion_30144_g77092;
				half Input_GlobalWind471_g77186 = Global_Wind_Power2223_g77092;
				half Global_MotionValue503_g77186 = TVE_MotionValue_30;
				half Input_GlobalNoise472_g77186 = Global_Noise_B5526_g77092;
				float lerpResult466_g77186 = lerp( 2.4 , 0.6 , Input_GlobalWind471_g77186);
				half Flutter_Amplitude491_g77186 = ( Input_MotionAmplitude58_g77186 * Input_MeshMotion_30374_g77186 * Input_GlobalWind471_g77186 * Global_MotionValue503_g77186 * pow( Input_GlobalNoise472_g77186 , lerpResult466_g77186 ) );
				half3 Motion_30_Flutter263_g77092 = ( Flutter_Texture489_g77186 * Flutter_Amplitude491_g77186 );
				float3 Vertex_Motion_Object833_g77092 = ( ( VertexPosRotationAxis50_g77168 + ( VertexPosOtherAxis82_g77168 * cos( Angle44_g77168 ) ) + ( cross( float3(0,1,0) , VertexPosOtherAxis82_g77168 ) * sin( Angle44_g77168 ) ) ) + Motion_30_Flutter263_g77092 );
				half3 ObjectData20_g77162 = Vertex_Motion_Object833_g77092;
				...
				half3 WorldData19_g77162 = Vertex_Motion_World1118_g77092;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g77162 = WorldData19_g77162;
				#else
				float3 staticSwitch14_g77162 = ObjectData20_g77162;
				#endif
				float3 temp_output_7495_0_g77092 = staticSwitch14_g77162;
				...
				float temp_output_84_0_g77126 = _LayerVertexValue;
				float temp_output_19_0_g77130 = TVE_VertexUsage[(int)temp_output_84_0_g77126];
				float4 temp_output_94_19_g77126 = TVE_VertexCoords;
				half2 UV97_g77126 = ( (temp_output_94_19_g77126).zw + ( (temp_output_94_19_g77126).xy * (ObjectPosition4223_g77092).xz ) );
				float4 tex2DArrayNode50_g77126 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_VertexTex, sampler_Linear_Clamp, UV97_g77126,temp_output_84_0_g77126, 0.0 );
				float4 temp_output_17_0_g77130 = tex2DArrayNode50_g77126;
				float4 temp_output_111_19_g77126 = TVE_VertexParams;
				float4 temp_output_3_0_g77130 = temp_output_111_19_g77126;
				float4 ifLocalVar18_g77130 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g77130 >= 0.5 )
				ifLocalVar18_g77130 = temp_output_17_0_g77130;
				else
				ifLocalVar18_g77130 = temp_output_3_0_g77130;
				float4 lerpResult22_g77130 = lerp( temp_output_3_0_g77130 , temp_output_17_0_g77130 , temp_output_19_0_g77130);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g77130 = lerpResult22_g77130;
				#else
				float4 staticSwitch24_g77130 = ifLocalVar18_g77130;
				#endif
				half4 Global_Vertex_Params4173_g77092 = staticSwitch24_g77130;
				float4 break322_g77131 = Global_Vertex_Params4173_g77092;
				half Global_VertexSize174_g77092 = saturate( break322_g77131.w );
				...
				half3 ObjectData20_g77159 = appendResult3480_g77092;
				half3 _Vector11 = half3(1,1,1);
				half3 WorldData19_g77159 = _Vector11;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g77159 = WorldData19_g77159;
				#else
				float3 staticSwitch14_g77159 = ObjectData20_g77159;
				#endif
				half3 Vertex_Size1741_g77092 = staticSwitch14_g77159;
				float temp_output_7_0_g77160 = _SizeFadeEndValue;
				float temp_output_10_0_g77160 = ( _SizeFadeStartValue - temp_output_7_0_g77160 );
				float temp_output_7453_0_g77092 = saturate( ( ( ( distance( _WorldSpaceCameraPos , ObjectPosition4223_g77092 ) * ( 1.0 / TVE_DistanceFadeBias ) ) - temp_output_7_0_g77160 ) / ( temp_output_10_0_g77160 + 0.0001 ) ) );
				float3 appendResult3482_g77092 = (float3(temp_output_7453_0_g77092 , temp_output_7453_0_g77092 , temp_output_7453_0_g77092));
				half3 ObjectData20_g77158 = appendResult3482_g77092;
				half3 _Vector5 = half3(1,1,1);
				half3 WorldData19_g77158 = _Vector5;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g77158 = WorldData19_g77158;
				#else
				float3 staticSwitch14_g77158 = ObjectData20_g77158;
				#endif
				float3 Vertex_SizeFade1740_g77092 = staticSwitch14_g77158;
				float3 lerpResult16_g77163 = lerp( VertexPosition3588_g77092 , ( ( ( Vertex_Motion7493_g77092 + Grass_Perspective2661_g77092 ) * Vertex_Size1741_g77092 * Vertex_SizeFade1740_g77092 ) + Mesh_PivotsOS2291_g77092 ) , TVE_IsEnabled);
				float3 temp_output_4912_0_g77092 = lerpResult16_g77163;
				float3 Final_VertexPosition890_g77092 = ( temp_output_4912_0_g77092 + _DisableSRPBatcher );
				
				float4 break33_g77219 = _second_uvs_mode;
				float2 temp_output_30_0_g77219 = ( v.texcoord.xy * break33_g77219.x );
				float2 appendResult21_g77214 = (float2(v.texcoord1.z , v.texcoord1.w));
				float2 Mesh_DetailCoord3_g77092 = appendResult21_g77214;
				float2 temp_output_29_0_g77219 = ( Mesh_DetailCoord3_g77092 * break33_g77219.y );
				float2 temp_output_31_0_g77219 = ( (WorldPosition_Shifted7477_g77092).xz * break33_g77219.z );
				...
				float2 vertexToFrag11_g77120 = ( ( ( temp_output_30_0_g77219 + temp_output_29_0_g77219 + temp_output_31_0_g77219 ) * lerpResult7614_g77092 ) + Second_UVs_Offset7605_g77092 );
				o.ase_texcoord9.xy = vertexToFrag11_g77120;
				o.ase_texcoord10.xyz = vertexToFrag3890_g77092;
				o.ase_texcoord11.xyz = vertexToFrag4224_g77092;
				half Global_Noise_A4860_g77092 = break638_g77190.a;
				...
				float vertexToFrag11_g77135 = Tint_Highlight_Value3231_g77092;
				o.ase_texcoord9.z = vertexToFrag11_g77135;
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float clampResult17_g77199 = clamp( Main_Mask57_g77092 , 0.0001 , 0.9999 );
				float temp_output_7_0_g77200 = _MainMaskMinValue;
				float temp_output_10_0_g77200 = ( _MainMaskMaxValue - temp_output_7_0_g77200 );
				half Main_Mask_Remap5765_g77092 = saturate( ( ( clampResult17_g77199 - temp_output_7_0_g77200 ) / ( temp_output_10_0_g77200 + 0.0001 ) ) );
				...
				float2 vertexToFrag11_g77120 = IN.ase_texcoord9.xy;
				half2 Second_UVs17_g77092 = vertexToFrag11_g77120;
				...
				float clampResult17_g77202 = clamp( Second_Mask81_g77092 , 0.0001 , 0.9999 );
				float temp_output_7_0_g77203 = _SecondMaskMinValue;
				float temp_output_10_0_g77203 = ( _SecondMaskMaxValue - temp_output_7_0_g77203 );
				half Second_Mask_Remap6130_g77092 = saturate( ( ( clampResult17_g77202 - temp_output_7_0_g77203 ) / ( temp_output_10_0_g77203 + 0.0001 ) ) );
				...
				float staticSwitch1_g77136 = 2.0;
				#else
				float staticSwitch1_g77136 = 4.594794;
				#endif
				float3 lerpResult4834_g77092 = lerp( ( Main_Albedo99_g77092 * Second_Albedo153_g77092 * staticSwitch1_g77136 ) , Second_Albedo153_g77092 , _DetailBlendMode);
				float lerpResult6885_g77092 = lerp( Main_Mask57_g77092 , Second_Mask81_g77092 , _DetailMaskMode);
				float clampResult17_g77172 = clamp( lerpResult6885_g77092 , 0.0001 , 0.9999 );
				float temp_output_7_0_g77171 = _DetailMaskMinValue;
				float temp_output_10_0_g77171 = ( _DetailMaskMaxValue - temp_output_7_0_g77171 );
				half Blend_Mask_Texture6794_g77092 = saturate( ( ( clampResult17_g77172 - temp_output_7_0_g77171 ) / ( temp_output_10_0_g77171 + 0.0001 ) ) );
				half Mesh_DetailMask90_g77092 = IN.ase_color.b;
				half4 Normal_Packed45_g77198 = SAMPLE_TEXTURE2D( _MainNormalTex, sampler_Linear_Repeat, Main_UVs15_g77092 );
				float2 appendResult58_g77198 = (float2(( (Normal_Packed45_g77198).x * (Normal_Packed45_g77198).w ) , (Normal_Packed45_g77198).y));
				half2 Normal_Default50_g77198 = appendResult58_g77198;
				half2 Normal_ASTC41_g77198 = (Normal_Packed45_g77198).xy;
				#ifdef UNITY_ASTC_NORMALMAP_ENCODING
				float2 staticSwitch38_g77198 = Normal_ASTC41_g77198;
				#else
				float2 staticSwitch38_g77198 = Normal_Default50_g77198;
				#endif
				half2 Normal_NO_DTX544_g77198 = (Normal_Packed45_g77198).wy;
				#ifdef UNITY_NO_DXT5nm
				float2 staticSwitch37_g77198 = Normal_NO_DTX544_g77198;
				#else
				float2 staticSwitch37_g77198 = staticSwitch38_g77198;
				#endif
				float2 temp_output_6555_0_g77092 = ( (staticSwitch37_g77198*2.0 + -1.0) * _MainNormalValue );
				...
				float clampResult17_g77170 = clamp( lerpResult6884_g77092 , 0.0001 , 0.9999 );
				float temp_output_7_0_g77169 = _DetailMeshMinValue;
				float temp_output_10_0_g77169 = ( _DetailMeshMaxValue - temp_output_7_0_g77169 );
				half Blend_Mask_Mesh1540_g77092 = saturate( ( ( clampResult17_g77170 - temp_output_7_0_g77169 ) / ( temp_output_10_0_g77169 + 0.0001 ) ) );
				float clampResult17_g77180 = clamp( ( Blend_Mask_Texture6794_g77092 * Blend_Mask_Mesh1540_g77092 ) , 0.0001 , 0.9999 );
				float temp_output_7_0_g77195 = _DetailBlendMinValue;
				float temp_output_10_0_g77195 = ( _DetailBlendMaxValue - temp_output_7_0_g77195 );
				half Blend_Mask147_g77092 = ( saturate( ( ( clampResult17_g77180 - temp_output_7_0_g77195 ) / ( temp_output_10_0_g77195 + 0.0001 ) ) ) * _DetailMode * _DetailValue );
				...
				float temp_output_7_0_g77145 = _GradientMinValue;
				float temp_output_10_0_g77145 = ( _GradientMaxValue - temp_output_7_0_g77145 );
				half Tint_Gradient_Value2784_g77092 = saturate( ( ( Mesh_Height1524_g77092 - temp_output_7_0_g77145 ) / ( temp_output_10_0_g77145 + 0.0001 ) ) );
				...
				float clampResult17_g77142 = clamp( Mesh_Occlusion318_g77092 , 0.0001 , 0.9999 );
				float temp_output_7_0_g77148 = _VertexOcclusionMinValue;
				float temp_output_10_0_g77148 = ( _VertexOcclusionMaxValue - temp_output_7_0_g77148 );
				half Occlusion_Mask6432_g77092 = saturate( ( ( clampResult17_g77142 - temp_output_7_0_g77148 ) / ( temp_output_10_0_g77148 + 0.0001 ) ) );
				...
				float3 temp_output_3_0_g77140 = Blend_Albedo_Tinted2808_g77092;
				float dotResult20_g77140 = dot( temp_output_3_0_g77140 , float3(0.2126,0.7152,0.0722) );
				half Blend_Albedo_Grayscale5939_g77092 = dotResult20_g77140;
				float3 temp_cast_1 = (Blend_Albedo_Grayscale5939_g77092).xxx;
				float temp_output_82_0_g77115 = _LayerColorsValue;
				float temp_output_19_0_g77119 = TVE_ColorsUsage[(int)temp_output_82_0_g77115];
				float4 temp_output_91_19_g77115 = TVE_ColorsCoords;
				...
				half2 UV94_g77115 = ( (temp_output_91_19_g77115).zw + ( (temp_output_91_19_g77115).xy * (lerpResult4822_g77092).xz ) );
				float4 tex2DArrayNode83_g77115 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, UV94_g77115,temp_output_82_0_g77115, 0.0 );
				float4 temp_output_17_0_g77119 = tex2DArrayNode83_g77115;
				float4 temp_output_92_86_g77115 = TVE_ColorsParams;
				float4 temp_output_3_0_g77119 = temp_output_92_86_g77115;
				float4 ifLocalVar18_g77119 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g77119 >= 0.5 )
				ifLocalVar18_g77119 = temp_output_17_0_g77119;
				else
				ifLocalVar18_g77119 = temp_output_3_0_g77119;
				float4 lerpResult22_g77119 = lerp( temp_output_3_0_g77119 , temp_output_17_0_g77119 , temp_output_19_0_g77119);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g77119 = lerpResult22_g77119;
				#else
				float4 staticSwitch24_g77119 = ifLocalVar18_g77119;
				#endif
				half4 Global_Colors_Params5434_g77092 = staticSwitch24_g77119;
				...
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g77132 = 2.0;
				#else
				float staticSwitch1_g77132 = 4.594794;
				#endif
				half3 Colors_RGB1954_g77092 = ( Global_Colors_RGB1700_g77092 * staticSwitch1_g77132 * _ColorsIntensityValue );
				half Colors_Value3692_g77092 = ( Blend_Mask_Remap6621_g77092 * _GlobalColors );
				float3 ObjectPosition_Shifted7481_g77092 = ( ObjectPosition4223_g77092 - TVE_WorldOrigin );
				half3 Input_Position167_g77207 = ObjectPosition_Shifted7481_g77092;
				float dotResult156_g77207 = dot( (Input_Position167_g77207).xz , float2( 12.9898,78.233 ) );
				half Vertex_DynamicMode5112_g77092 = _VertexDynamicMode;
				...
				float lerpResult6459_g77092 = lerp( Occlusion_Mask6432_g77092 , ( 1.0 - Occlusion_Mask6432_g77092 ) , _ColorsMaskMode);
				...
				float3 temp_output_3_0_g77141 = ( Blend_Albedo265_g77092 * Tint_Gradient_Color5769_g77092 * Tint_Noise_Color5770_g77092 );
				float dotResult20_g77141 = dot( temp_output_3_0_g77141 , float3(0.2126,0.7152,0.0722) );
				float clampResult6740_g77092 = clamp( saturate( ( dotResult20_g77141 * 5.0 ) ) , 0.2 , 1.0 );
				half Blend_Albedo_Globals6410_g77092 = clampResult6740_g77092;
				float temp_output_7_0_g77178 = 0.1;
				float temp_output_10_0_g77178 = ( 0.2 - temp_output_7_0_g77178 );
				float lerpResult16_g77133 = lerp( 0.0 , saturate( ( ( ( Colors_Value3692_g77092 * Colors_Influence3668_g77092 * Colors_Variation3650_g77092 * Occlusion_Colors6450_g77092 * Blend_Albedo_Globals6410_g77092 ) - temp_output_7_0_g77178 ) / ( temp_output_10_0_g77178 + 0.0001 ) ) ) , TVE_IsEnabled);
				float3 lerpResult3628_g77092 = lerp( Blend_Albedo_Tinted2808_g77092 , ( lerpResult3618_g77092 * Colors_RGB1954_g77092 ) , lerpResult16_g77133);
				...
				float temp_output_84_0_g77110 = _LayerExtrasValue;
				float temp_output_19_0_g77114 = TVE_ExtrasUsage[(int)temp_output_84_0_g77110];
				float4 temp_output_93_19_g77110 = TVE_ExtrasCoords;
				float3 lerpResult4827_g77092 = lerp( WorldPosition3905_g77092 , ObjectPosition4223_g77092 , _ExtrasPositionMode);
				half2 UV96_g77110 = ( (temp_output_93_19_g77110).zw + ( (temp_output_93_19_g77110).xy * (lerpResult4827_g77092).xz ) );
				float4 tex2DArrayNode48_g77110 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_Linear_Clamp, UV96_g77110,temp_output_84_0_g77110, 0.0 );
				float4 temp_output_17_0_g77114 = tex2DArrayNode48_g77110;
				float4 temp_output_94_85_g77110 = TVE_ExtrasParams;
				float4 temp_output_3_0_g77114 = temp_output_94_85_g77110;
				float4 ifLocalVar18_g77114 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g77114 >= 0.5 )
				ifLocalVar18_g77114 = temp_output_17_0_g77114;
				else
				ifLocalVar18_g77114 = temp_output_3_0_g77114;
				float4 lerpResult22_g77114 = lerp( temp_output_3_0_g77114 , temp_output_17_0_g77114 , temp_output_19_0_g77114);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g77114 = lerpResult22_g77114;
				#else
				float4 staticSwitch24_g77114 = ifLocalVar18_g77114;
				#endif
				half4 Global_Extras_Params5440_g77092 = staticSwitch24_g77114;
				float4 break456_g77124 = Global_Extras_Params5440_g77092;
				half Global_Extras_Overlay156_g77092 = break456_g77124.z;
				...
				half4 Normal_Packed45_g77201 = SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_Linear_Repeat, Second_UVs17_g77092 );
				float2 appendResult58_g77201 = (float2(( (Normal_Packed45_g77201).x * (Normal_Packed45_g77201).w ) , (Normal_Packed45_g77201).y));
				half2 Normal_Default50_g77201 = appendResult58_g77201;
				half2 Normal_ASTC41_g77201 = (Normal_Packed45_g77201).xy;
				#ifdef UNITY_ASTC_NORMALMAP_ENCODING
				float2 staticSwitch38_g77201 = Normal_ASTC41_g77201;
				#else
				float2 staticSwitch38_g77201 = Normal_Default50_g77201;
				#endif
				half2 Normal_NO_DTX544_g77201 = (Normal_Packed45_g77201).wy;
				#ifdef UNITY_NO_DXT5nm
				float2 staticSwitch37_g77201 = Normal_NO_DTX544_g77201;
				#else
				float2 staticSwitch37_g77201 = staticSwitch38_g77201;
				#endif
				float2 temp_output_6560_0_g77092 = ( (staticSwitch37_g77201*2.0 + -1.0) * _SecondNormalValue );
				half2 Normal_Planar45_g77204 = temp_output_6560_0_g77092;
				float2 break64_g77204 = Normal_Planar45_g77204;
				float3 appendResult65_g77204 = (float3(break64_g77204.x , 0.0 , break64_g77204.y));
				float2 temp_output_7603_0_g77092 = (mul( ase_worldToTangent, appendResult65_g77204 )).xy;
				...
				float2 temp_output_36_0_g77137 = ( lerpResult3372_g77092 + Second_Normal179_g77092 );
				float2 lerpResult3376_g77092 = lerp( Main_Normal137_g77092 , temp_output_36_0_g77137 , Blend_Mask147_g77092);
				#ifdef TVE_FEATURE_DETAIL
				...
				float lerpResult6467_g77092 = lerp( Occlusion_Alpha6463_g77092 , 1.0 , Occlusion_Mask6432_g77092);
				half Occlusion_Overlay6471_g77092 = lerpResult6467_g77092;
				float temp_output_7_0_g77146 = 0.1;
				float temp_output_10_0_g77146 = ( 0.2 - temp_output_7_0_g77146 );
				half Overlay_Mask_High6064_g77092 = saturate( ( ( ( Overlay_Value5738_g77092 * Overlay_Projection6081_g77092 * Overlay_Shading6688_g77092 * Overlay_Custom6707_g77092 * Occlusion_Overlay6471_g77092 ) - temp_output_7_0_g77146 ) / ( temp_output_10_0_g77146 + 0.0001 ) ) );
				...
				half Global_Extras_Wetness305_g77092 = break456_g77124.y;
				...
				float vertexToFrag11_g77135 = IN.ase_texcoord9.z;
				half3 Tint_Highlight_Color5771_g77092 = ( ( (_MotionHighlightColor).rgb * vertexToFrag11_g77135 ) + float3( 1,1,1 ) );
				...
				float3 temp_output_13_0_g77125 = appendResult6568_g77092;
				float3 temp_output_33_0_g77125 = ( temp_output_13_0_g77125 * _render_normals );
				float3 switchResult12_g77125 = (((ase_vface>0)?(temp_output_13_0_g77125):(temp_output_33_0_g77125)));
				...
				float temp_output_7_0_g77220 = _EmissiveTexMinValue;
				float3 temp_cast_12 = (temp_output_7_0_g77220).xxx;
				float temp_output_10_0_g77220 = ( _EmissiveTexMaxValue - temp_output_7_0_g77220 );
				half3 Emissive_Texture7022_g77092 = saturate( ( ( (SAMPLE_TEXTURE2D( _EmissiveTex, sampler_Linear_Repeat, Emissive_UVs2468_g77092 )).rgb - temp_cast_12 ) / ( temp_output_10_0_g77220 + 0.0001 ) ) );
				half Global_Extras_Emissive4203_g77092 = break456_g77124.x;
				...
				float3 temp_output_3_0_g77222 = ( Emissive_Color7162_g77092 * Emissive_Mask6968_g77092 );
				float temp_output_15_0_g77222 = _emissive_intensity_value;
				float3 temp_output_23_0_g77222 = ( temp_output_3_0_g77222 * temp_output_15_0_g77222 );
				#ifdef _TVE_FEATURE_EMISSIVE
				float3 staticSwitch7687_g77092 = temp_output_23_0_g77222;
				#else
				...
				float localCustomAlphaClip19_g77197 = ( 0.0 );
				...
				half Global_Extras_Alpha1033_g77092 = saturate( break456_g77124.w );
				...
				float lerpResult16_g77138 = lerp( 1.0 , lerpResult5203_g77092 , TVE_IsEnabled);
				half Global_Alpha315_g77092 = lerpResult16_g77138;
				...
				float temp_output_7_0_g77147 = TVE_CameraFadeMin;
				float temp_output_10_0_g77147 = ( TVE_CameraFadeMax - temp_output_7_0_g77147 );
				float lerpResult4755_g77092 = lerp( 1.0 , saturate( saturate( ( ( distance( WorldPosition , _WorldSpaceCameraPos ) - temp_output_7_0_g77147 ) / ( temp_output_10_0_g77147 + 0.0001 ) ) ) ) , _FadeCameraValue);
				...
				float temp_output_3_0_g77197 = Final_Alpha7344_g77092;
				float Alpha19_g77197 = temp_output_3_0_g77197;
				float temp_output_15_0_g77197 = 0.01;
				float Treshold19_g77197 = temp_output_15_0_g77197;
				{
				...
				clip(Alpha19_g77197 - Treshold19_g77197);
				#endif
				#else
				clip(Alpha19_g77197 - Treshold19_g77197);
				#endif
				...
				half Final_Clip914_g77092 = saturate( ( Alpha19_g77197 * Blend_Color_Alpha6167_g77092 ) );
				...
				float3 Normal = switchResult12_g77125;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				half Input_MeshHeight388_g77181 = Mesh_Motion_107572_g77092;
				half ObjectData20_g77182 = Input_MeshHeight388_g77181;
				float enc62_g77214 = v.ase_texcoord.w;
				float2 localDecodeFloatToVector262_g77214 = DecodeFloatToVector2( enc62_g77214 );
				float2 break63_g77214 = ( localDecodeFloatToVector262_g77214 * 100.0 );
				float Bounds_Height5230_g77092 = break63_g77214.x;
				half Input_BoundsHeight390_g77181 = Bounds_Height5230_g77092;
				...
				half Motion_Amplitude418_g77205 = ( Input_MotionAmplitude384_g77205 * Input_GlobalWind407_g77205 * pow( Input_GlobalNoise411_g77205 , lerpResult413_g77205 ) );
				half Input_Squash58_g77205 = _MotionAmplitude_20;
				float enc59_g77214 = v.ase_texcoord.z;
				float2 localDecodeFloatToVector259_g77214 = DecodeFloatToVector2( enc59_g77214 );
				float2 break61_g77214 = localDecodeFloatToVector259_g77214;
				half Mesh_Motion_2060_g77092 = break61_g77214.x;
				half Input_MeshMotion_20388_g77205 = Mesh_Motion_2060_g77092;
				...
				float4 break33_g77219 = _second_uvs_mode;
				float2 temp_output_30_0_g77219 = ( v.ase_texcoord.xy * break33_g77219.x );
				float2 appendResult21_g77214 = (float2(v.ase_texcoord1.z , v.ase_texcoord1.w));
				float2 Mesh_DetailCoord3_g77092 = appendResult21_g77214;
				float2 temp_output_29_0_g77219 = ( Mesh_DetailCoord3_g77092 * break33_g77219.y );
				float2 temp_output_31_0_g77219 = ( (WorldPosition_Shifted7477_g77092).xz * break33_g77219.z );
				half2 Second_UVs_Tilling7609_g77092 = (_SecondUVs).xy;
				...
				half2 Second_UVs_Offset7605_g77092 = (_SecondUVs).zw;
				float2 vertexToFrag11_g77120 = ( ( ( temp_output_30_0_g77219 + temp_output_29_0_g77219 + temp_output_31_0_g77219 ) * lerpResult7614_g77092 ) + Second_UVs_Offset7605_g77092 );
				o.ase_texcoord4.xy = vertexToFrag11_g77120;
						 ...
						 ) : SV_TARGET
			{
				...
				float4 tex2DNode29_g77092 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g77092 );
				half Main_Alpha316_g77092 = tex2DNode29_g77092.a;
				float2 vertexToFrag11_g77120 = IN.ase_texcoord4.xy;
				half2 Second_UVs17_g77092 = vertexToFrag11_g77120;
				float4 tex2DNode89_g77092 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g77092 );
				half Second_Alpha5007_g77092 = tex2DNode89_g77092.a;
				float4 tex2DNode35_g77092 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_Linear_Repeat, Main_UVs15_g77092 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half Input_MeshHeight388_g77181 = Mesh_Motion_107572_g77092;
				half ObjectData20_g77182 = Input_MeshHeight388_g77181;
				float enc62_g77214 = v.texcoord0.w;
				float2 localDecodeFloatToVector262_g77214 = DecodeFloatToVector2( enc62_g77214 );
				float2 break63_g77214 = ( localDecodeFloatToVector262_g77214 * 100.0 );
				float Bounds_Height5230_g77092 = break63_g77214.x;
				half Input_BoundsHeight390_g77181 = Bounds_Height5230_g77092;
				...
				half Motion_Amplitude418_g77205 = ( Input_MotionAmplitude384_g77205 * Input_GlobalWind407_g77205 * pow( Input_GlobalNoise411_g77205 , lerpResult413_g77205 ) );
				half Input_Squash58_g77205 = _MotionAmplitude_20;
				float enc59_g77214 = v.texcoord0.z;
				float2 localDecodeFloatToVector259_g77214 = DecodeFloatToVector2( enc59_g77214 );
				float2 break61_g77214 = localDecodeFloatToVector259_g77214;
				half Mesh_Motion_2060_g77092 = break61_g77214.x;
				half Input_MeshMotion_20388_g77205 = Mesh_Motion_2060_g77092;
				...
				float4 break33_g77219 = _second_uvs_mode;
				float2 temp_output_30_0_g77219 = ( v.texcoord0.xy * break33_g77219.x );
				float2 appendResult21_g77214 = (float2(v.texcoord1.z , v.texcoord1.w));
				float2 Mesh_DetailCoord3_g77092 = appendResult21_g77214;
				float2 temp_output_29_0_g77219 = ( Mesh_DetailCoord3_g77092 * break33_g77219.y );
				float2 temp_output_31_0_g77219 = ( (WorldPosition_Shifted7477_g77092).xz * break33_g77219.z );
				...
				half2 Second_UVs_Offset7605_g77092 = (_SecondUVs).zw;
				float2 vertexToFrag11_g77120 = ( ( ( temp_output_30_0_g77219 + temp_output_29_0_g77219 + temp_output_31_0_g77219 ) * lerpResult7614_g77092 ) + Second_UVs_Offset7605_g77092 );
				o.ase_texcoord5.xy = vertexToFrag11_g77120;
				float3 ase_worldTangent = TransformObjectToWorldDir(v.ase_tangent.xyz);
				...
				half Tint_Highlight_Value3231_g77092 = ( Global_Noise_A4860_g77092 * Global_Wind_Power2223_g77092 * Motion_FadeOut4005_g77092 * Mesh_Height1524_g77092 );
				float vertexToFrag11_g77135 = Tint_Highlight_Value3231_g77092;
				o.ase_texcoord5.z = vertexToFrag11_g77135;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half3 Main_Color_RGB7657_g77092 = (lerpResult7654_g77092).rgb;
				half3 Main_Albedo99_g77092 = ( lerpResult6223_g77092 * Main_Color_RGB7657_g77092 );
				float2 vertexToFrag11_g77120 = IN.ase_texcoord5.xy;
				half2 Second_UVs17_g77092 = vertexToFrag11_g77120;
				float4 tex2DNode89_g77092 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g77092 );
				float3 lerpResult6225_g77092 = lerp( float3( 1,1,1 ) , (tex2DNode89_g77092).rgb , _SecondAlbedoValue);
				float4 tex2DNode33_g77092 = SAMPLE_TEXTURE2D( _SecondMaskTex, sampler_Linear_Repeat, Second_UVs17_g77092 );
				...
				float3 lerpResult6367_g77092 = lerp( Blend_Albedo_Overlay359_g77092 , ( Blend_Albedo_Overlay359_g77092 * Blend_Albedo_Overlay359_g77092 ) , ( Global_WetnessContrast6502_g77092 * Wetness_Value6343_g77092 ));
				half3 Blend_Albedo_Wetness6351_g77092 = lerpResult6367_g77092;
				float vertexToFrag11_g77135 = IN.ase_texcoord5.z;
				half3 Tint_Highlight_Color5771_g77092 = ( ( (_MotionHighlightColor).rgb * vertexToFrag11_g77135 ) + float3( 1,1,1 ) );
				float3 temp_output_6309_0_g77092 = ( Blend_Albedo_Wetness6351_g77092 * Tint_Highlight_Color5771_g77092 );
				half3 Blend_Albedo_Subsurface149_g77092 = temp_output_6309_0_g77092;
				half3 Blend_Albedo_RimLight7316_g77092 = Blend_Albedo_Subsurface149_g77092;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half2 Second_UVs_Offset7605_g77092 = (_SecondUVs).zw;
				float2 vertexToFrag11_g77120 = ( ( ( temp_output_30_0_g77219 + temp_output_29_0_g77219 + temp_output_31_0_g77219 ) * lerpResult7614_g77092 ) + Second_UVs_Offset7605_g77092 );
				o.ase_texcoord3.xy = vertexToFrag11_g77120;
				float3 ase_worldTangent = TransformObjectToWorldDir(v.ase_tangent.xyz);
				...
				half Tint_Highlight_Value3231_g77092 = ( Global_Noise_A4860_g77092 * Global_Wind_Power2223_g77092 * Motion_FadeOut4005_g77092 * Mesh_Height1524_g77092 );
				float vertexToFrag11_g77135 = Tint_Highlight_Value3231_g77092;
				o.ase_texcoord3.z = vertexToFrag11_g77135;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half3 Main_Color_RGB7657_g77092 = (lerpResult7654_g77092).rgb;
				half3 Main_Albedo99_g77092 = ( lerpResult6223_g77092 * Main_Color_RGB7657_g77092 );
				float2 vertexToFrag11_g77120 = IN.ase_texcoord3.xy;
				half2 Second_UVs17_g77092 = vertexToFrag11_g77120;
				float4 tex2DNode89_g77092 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g77092 );
				float3 lerpResult6225_g77092 = lerp( float3( 1,1,1 ) , (tex2DNode89_g77092).rgb , _SecondAlbedoValue);
				float4 tex2DNode33_g77092 = SAMPLE_TEXTURE2D( _SecondMaskTex, sampler_Linear_Repeat, Second_UVs17_g77092 );
				...
				float3 lerpResult6367_g77092 = lerp( Blend_Albedo_Overlay359_g77092 , ( Blend_Albedo_Overlay359_g77092 * Blend_Albedo_Overlay359_g77092 ) , ( Global_WetnessContrast6502_g77092 * Wetness_Value6343_g77092 ));
				half3 Blend_Albedo_Wetness6351_g77092 = lerpResult6367_g77092;
				float vertexToFrag11_g77135 = IN.ase_texcoord3.z;
				half3 Tint_Highlight_Color5771_g77092 = ( ( (_MotionHighlightColor).rgb * vertexToFrag11_g77135 ) + float3( 1,1,1 ) );
				float3 temp_output_6309_0_g77092 = ( Blend_Albedo_Wetness6351_g77092 * Tint_Highlight_Color5771_g77092 );
				half3 Blend_Albedo_Subsurface149_g77092 = temp_output_6309_0_g77092;
				half3 Blend_Albedo_RimLight7316_g77092 = Blend_Albedo_Subsurface149_g77092;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half2 Second_UVs_Offset7605_g77092 = (_SecondUVs).zw;
				float2 vertexToFrag11_g77120 = ( ( ( temp_output_30_0_g77219 + temp_output_29_0_g77219 + temp_output_31_0_g77219 ) * lerpResult7614_g77092 ) + Second_UVs_Offset7605_g77092 );
				o.ase_texcoord7.xy = vertexToFrag11_g77120;
				o.ase_texcoord8.xyz = vertexToFrag3890_g77092;
				o.ase_texcoord9.xyz = vertexToFrag4224_g77092;
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float2 vertexToFrag11_g77120 = IN.ase_texcoord7.xy;
				half2 Second_UVs17_g77092 = vertexToFrag11_g77120;
				half4 Normal_Packed45_g77201 = SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_Linear_Repeat, Second_UVs17_g77092 );
				float2 appendResult58_g77201 = (float2(( (Normal_Packed45_g77201).x * (Normal_Packed45_g77201).w ) , (Normal_Packed45_g77201).y));
				half2 Normal_Default50_g77201 = appendResult58_g77201;
		...
		Pass
		{
			...
			VertexOutput VertexFunction(VertexInput v  )
			{
				...
				half2 Second_UVs_Offset7605_g77092 = (_SecondUVs).zw;
				float2 vertexToFrag11_g77120 = ( ( ( temp_output_30_0_g77219 + temp_output_29_0_g77219 + temp_output_31_0_g77219 ) * lerpResult7614_g77092 ) + Second_UVs_Offset7605_g77092 );
				o.ase_texcoord1.xy = vertexToFrag11_g77120;
				float3 ase_worldTangent = TransformObjectToWorldDir(v.ase_tangent.xyz);
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 tex2DNode29_g77092 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g77092 );
				half Main_Alpha316_g77092 = tex2DNode29_g77092.a;
				float2 vertexToFrag11_g77120 = IN.ase_texcoord1.xy;
				half2 Second_UVs17_g77092 = vertexToFrag11_g77120;
				float4 tex2DNode89_g77092 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g77092 );
				half Second_Alpha5007_g77092 = tex2DNode89_g77092.a;
				float4 tex2DNode35_g77092 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_Linear_Repeat, Main_UVs15_g77092 );
				...
				float temp_output_7_0_g77147 = TVE_CameraFadeMin;
				float temp_output_10_0_g77147 = ( TVE_CameraFadeMax - temp_output_7_0_g77147 );
				float lerpResult4755_g77092 = lerp( 1.0 , saturate( saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g77147 ) / ( temp_output_10_0_g77147 + 0.0001 ) ) ) ) , _FadeCameraValue);
				half Fade_Camera3743_g77092 = lerpResult4755_g77092;
				half Fade_Effects_B6228_g77092 = ( Fade_Effects_A5360_g77092 * Fade_Camera3743_g77092 );
				half Fade_Mask5149_g77092 = ( 1.0 * Blend_Mask_Invert6260_g77092 );
				float lerpResult5141_g77092 = lerp( 1.0 , ( Fade_Effects_B6228_g77092 * ( 1.0 - _FadeConstantValue ) ) , Fade_Mask5149_g77092);
...
/*ASEBEGIN
Version=19202
Node;AmplifyShaderEditor.RangedFloatNode;17;-1632,-640;Half;False;Property;_render_zw;_render_zw;250;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1030;-1408,-640;Half;False;Property;_render_coverage;_render_coverage;251;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-2176,-640;Half;False;Property;_render_cull;_render_cull;247;1;[HideInInspector];Create;True;0;3;Both;0;Back;1;Front;2;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-2000,-640;Half;False;Property;_render_src;_render_src;248;1;[HideInInspector];Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;7;-1808,-640;Half;False;Property;_render_dst;_render_dst;249;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;10;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;471;-1664,640;Inherit;False;Define ShaderType Plant;254;;76955;b458122dd75182d488380bd0f592b9e6;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1049;-1936,640;Inherit;False;Define Lighting Subsurface;252;;77091;77137addbb4a22f4c818adc8782926be;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1048;-2177,-257;Inherit;False;Base Shader Core;0;;77092;856f7164d1c579d43a5cf4968a75ca43;95,7343,0,3880,1,4028,1,3900,1,3908,1,4172,1,4179,1,6791,1,1298,1,1300,1,6792,1,3586,0,4499,1,1708,1,6056,1,3509,1,3873,1,893,1,6230,0,5156,1,5345,0,7566,1,1718,1,1717,1,1715,1,6116,1,5075,1,1714,1,6076,1,6592,1,6068,1,6692,0,6729,1,1776,1,6378,1,3475,1,6352,1,6655,1,4210,1,1745,1,3479,0,1646,0,3501,1,2807,1,6206,1,7565,1,4999,0,6194,0,3887,0,7321,0,7332,0,3957,1,6647,0,6257,0,5357,0,2172,1,3883,0,3728,1,7650,0,5350,0,2658,1,7617,0,1742,1,3484,0,4837,1,1734,1,1737,1,6161,1,6166,1,1735,1,1736,1,6320,1,6622,1,6848,1,7429,0,7624,0,6721,1,860,1,2260,1,2261,1,2032,1,2054,1,5258,1,2062,1,2039,1,7548,1,7550,1,3243,1,5220,1,4217,1,6699,1,5339,0,5090,1,4242,1,7492,0;10;7333;FLOAT3;1,1,1;False;6196;FLOAT;1;False;6693;FLOAT;1;False;6201;FLOAT;1;False;6205;FLOAT;1;False;7652;FLOAT;1;False;5143;FLOAT;1;False;6231;FLOAT;1;False;6198;FLOAT;1;False;5340;FLOAT3;0,0,0;False;23;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4842;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT;532;FLOAT;5389;FLOAT;721;FLOAT3;1230;FLOAT;5296;FLOAT;1461;FLOAT;1290;FLOAT;629;FLOAT3;534;FLOAT;4867;FLOAT4;5246;FLOAT4;4841
...
ASEEND*/
//CHKSM=B2BD4ADA2A5CA1A66E978FF17D6960F8ED5C4D89