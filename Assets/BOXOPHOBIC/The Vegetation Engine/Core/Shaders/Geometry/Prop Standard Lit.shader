	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 vertexToFrag11_g76429 = ( ( ( temp_output_30_0_g76581 + temp_output_29_0_g76581 + temp_output_31_0_g76581 ) * lerpResult7614_g76401 ) + Second_UVs_Offset7605_g76401 );
				o.ase_texcoord9.xy = vertexToFrag11_g76429;
				o.ase_texcoord10.xyz = vertexToFrag3890_g76401;
				float4x4 break19_g76459 = GetObjectToWorldMatrix();
				float3 appendResult20_g76459 = (float3(break19_g76459[ 0 ][ 3 ] , break19_g76459[ 1 ][ 3 ] , break19_g76459[ 2 ][ 3 ]));
				...
				float3 temp_output_122_0_g76459 = Mesh_PivotsData2831_g76401;
				float3 PivotsOnly105_g76459 = (mul( GetObjectToWorldMatrix(), float4( temp_output_122_0_g76459 , 0.0 ) ).xyz).xyz;
				half3 ObjectData20_g76461 = ( appendResult20_g76459 + PivotsOnly105_g76459 );
				half3 WorldData19_g76461 = ase_worldPos;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g76461 = WorldData19_g76461;
				#else
				float3 staticSwitch14_g76461 = ObjectData20_g76461;
				#endif
				float3 temp_output_114_0_g76459 = staticSwitch14_g76461;
				float3 vertexToFrag4224_g76401 = temp_output_114_0_g76459;
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 vertexToFrag11_g76429 = IN.ase_texcoord9.xy;
				half2 Second_UVs17_g76401 = vertexToFrag11_g76429;
				...
				float staticSwitch1_g76445 = 2.0;
				#else
				float staticSwitch1_g76445 = 4.594794;
				#endif
				float3 lerpResult4834_g76401 = lerp( ( Main_Albedo99_g76401 * Second_Albedo153_g76401 * staticSwitch1_g76445 ) , Second_Albedo153_g76401 , _DetailBlendMode);
				...
				float clampResult17_g76451 = clamp( Mesh_Occlusion318_g76401 , 0.0001 , 0.9999 );
				float temp_output_7_0_g76457 = _VertexOcclusionMinValue;
				float temp_output_10_0_g76457 = ( _VertexOcclusionMaxValue - temp_output_7_0_g76457 );
				half Occlusion_Mask6432_g76401 = saturate( ( ( clampResult17_g76451 - temp_output_7_0_g76457 ) / ( temp_output_10_0_g76457 + 0.0001 ) ) );
				...
				float3 temp_output_3_0_g76449 = Blend_Albedo_Tinted2808_g76401;
				float dotResult20_g76449 = dot( temp_output_3_0_g76449 , float3(0.2126,0.7152,0.0722) );
				half Blend_Albedo_Grayscale5939_g76401 = dotResult20_g76449;
				float3 temp_cast_1 = (Blend_Albedo_Grayscale5939_g76401).xxx;
				float temp_output_82_0_g76424 = _LayerColorsValue;
				float temp_output_19_0_g76428 = TVE_ColorsUsage[(int)temp_output_82_0_g76424];
				float4 temp_output_91_19_g76424 = TVE_ColorsCoords;
				...
				half2 UV94_g76424 = ( (temp_output_91_19_g76424).zw + ( (temp_output_91_19_g76424).xy * (lerpResult4822_g76401).xz ) );
				float4 tex2DArrayNode83_g76424 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, UV94_g76424,temp_output_82_0_g76424, 0.0 );
				float4 temp_output_17_0_g76428 = tex2DArrayNode83_g76424;
				float4 temp_output_92_86_g76424 = TVE_ColorsParams;
				float4 temp_output_3_0_g76428 = temp_output_92_86_g76424;
				float4 ifLocalVar18_g76428 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g76428 >= 0.5 )
				ifLocalVar18_g76428 = temp_output_17_0_g76428;
				else
				ifLocalVar18_g76428 = temp_output_3_0_g76428;
				float4 lerpResult22_g76428 = lerp( temp_output_3_0_g76428 , temp_output_17_0_g76428 , temp_output_19_0_g76428);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g76428 = lerpResult22_g76428;
				#else
				float4 staticSwitch24_g76428 = ifLocalVar18_g76428;
				#endif
				half4 Global_Colors_Params5434_g76401 = staticSwitch24_g76428;
				...
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g76441 = 2.0;
				#else
				float staticSwitch1_g76441 = 4.594794;
				#endif
				half3 Colors_RGB1954_g76401 = ( Global_Colors_RGB1700_g76401 * staticSwitch1_g76441 * _ColorsIntensityValue );
				...
				half Colors_Value3692_g76401 = ( Blend_Mask_Remap6621_g76401 * _GlobalColors );
				half Colors_Variation3650_g76401 = 1.0;
				half Occlusion_Alpha6463_g76401 = _VertexOcclusionColor.a;
				float lerpResult6459_g76401 = lerp( Occlusion_Mask6432_g76401 , ( 1.0 - Occlusion_Mask6432_g76401 ) , _ColorsMaskMode);
				...
				float3 temp_output_3_0_g76450 = ( Blend_Albedo265_g76401 * Tint_Gradient_Color5769_g76401 * Tint_Noise_Color5770_g76401 );
				float dotResult20_g76450 = dot( temp_output_3_0_g76450 , float3(0.2126,0.7152,0.0722) );
				float clampResult6740_g76401 = clamp( saturate( ( dotResult20_g76450 * 5.0 ) ) , 0.2 , 1.0 );
				...
				float lerpResult16_g76442 = lerp( 0.0 , saturate( ( ( ( Colors_Value3692_g76401 * Colors_Influence3668_g76401 * Colors_Variation3650_g76401 * Occlusion_Colors6450_g76401 * Blend_Albedo_Globals6410_g76401 ) - temp_output_7_0_g76489 ) / ( temp_output_10_0_g76489 + 0.0001 ) ) ) , TVE_IsEnabled);
				float3 lerpResult3628_g76401 = lerp( Blend_Albedo_Tinted2808_g76401 , ( lerpResult3618_g76401 * Colors_RGB1954_g76401 ) , lerpResult16_g76442);
				...
				float4 break456_g76433 = Global_Extras_Params5440_g76401;
				half Global_Extras_Overlay156_g76401 = break456_g76433.z;
				...
				float2 temp_output_36_0_g76446 = ( lerpResult3372_g76401 + Second_Normal179_g76401 );
				float2 lerpResult3376_g76401 = lerp( Main_Normal137_g76401 , temp_output_36_0_g76446 , Blend_Mask147_g76401);
				#ifdef TVE_FEATURE_DETAIL
				...
				float temp_output_7_0_g76455 = 0.1;
				float temp_output_10_0_g76455 = ( 0.2 - temp_output_7_0_g76455 );
				half Overlay_Mask_High6064_g76401 = saturate( ( ( ( Overlay_Value5738_g76401 * Overlay_Projection6081_g76401 * Overlay_Shading6688_g76401 * Overlay_Custom6707_g76401 * Occlusion_Overlay6471_g76401 ) - temp_output_7_0_g76455 ) / ( temp_output_10_0_g76455 + 0.0001 ) ) );
				...
				half Global_Extras_Wetness305_g76401 = break456_g76433.y;
				...
				float3 temp_output_13_0_g76434 = appendResult6568_g76401;
				float3 temp_output_33_0_g76434 = ( temp_output_13_0_g76434 * _render_normals );
				float3 switchResult12_g76434 = (((ase_vface>0)?(temp_output_13_0_g76434):(temp_output_33_0_g76434)));
				...
				half Global_Extras_Emissive4203_g76401 = break456_g76433.x;
				...
				float temp_output_7_0_g76456 = TVE_CameraFadeMin;
				float temp_output_10_0_g76456 = ( TVE_CameraFadeMax - temp_output_7_0_g76456 );
				float lerpResult4755_g76401 = lerp( 1.0 , saturate( saturate( ( ( distance( WorldPosition , _WorldSpaceCameraPos ) - temp_output_7_0_g76456 ) / ( temp_output_10_0_g76456 + 0.0001 ) ) ) ) , _FadeCameraValue);
				...
				float3 Normal = switchResult12_g76434;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				half2 Second_UVs_Offset7605_g76401 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76429 = ( ( ( temp_output_30_0_g76581 + temp_output_29_0_g76581 + temp_output_31_0_g76581 ) * lerpResult7614_g76401 ) + Second_UVs_Offset7605_g76401 );
				o.ase_texcoord4.xy = vertexToFrag11_g76429;
						 ...
						 ) : SV_TARGET
			{
				...
				float4 tex2DNode29_g76401 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g76401 );
				half Main_Alpha316_g76401 = tex2DNode29_g76401.a;
				float2 vertexToFrag11_g76429 = IN.ase_texcoord4.xy;
				half2 Second_UVs17_g76401 = vertexToFrag11_g76429;
				float4 tex2DNode89_g76401 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g76401 );
				half Second_Alpha5007_g76401 = tex2DNode89_g76401.a;
				float4 tex2DNode35_g76401 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_Linear_Repeat, Main_UVs15_g76401 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half2 Second_UVs_Offset7605_g76401 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76429 = ( ( ( temp_output_30_0_g76581 + temp_output_29_0_g76581 + temp_output_31_0_g76581 ) * lerpResult7614_g76401 ) + Second_UVs_Offset7605_g76401 );
				o.ase_texcoord5.xy = vertexToFrag11_g76429;
				float3 ase_worldTangent = TransformObjectToWorldDir(v.ase_tangent.xyz);
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half3 Main_Color_RGB7657_g76401 = (lerpResult7654_g76401).rgb;
				half3 Main_Albedo99_g76401 = ( lerpResult6223_g76401 * Main_Color_RGB7657_g76401 );
				float2 vertexToFrag11_g76429 = IN.ase_texcoord5.xy;
				half2 Second_UVs17_g76401 = vertexToFrag11_g76429;
				float4 tex2DNode89_g76401 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g76401 );
				float3 lerpResult6225_g76401 = lerp( float3( 1,1,1 ) , (tex2DNode89_g76401).rgb , _SecondAlbedoValue);
				float4 tex2DNode33_g76401 = SAMPLE_TEXTURE2D( _SecondMaskTex, sampler_Linear_Repeat, Second_UVs17_g76401 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half2 Second_UVs_Offset7605_g76401 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76429 = ( ( ( temp_output_30_0_g76581 + temp_output_29_0_g76581 + temp_output_31_0_g76581 ) * lerpResult7614_g76401 ) + Second_UVs_Offset7605_g76401 );
				o.ase_texcoord3.xy = vertexToFrag11_g76429;
				float3 ase_worldTangent = TransformObjectToWorldDir(v.ase_tangent.xyz);
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half3 Main_Color_RGB7657_g76401 = (lerpResult7654_g76401).rgb;
				half3 Main_Albedo99_g76401 = ( lerpResult6223_g76401 * Main_Color_RGB7657_g76401 );
				float2 vertexToFrag11_g76429 = IN.ase_texcoord3.xy;
				half2 Second_UVs17_g76401 = vertexToFrag11_g76429;
				float4 tex2DNode89_g76401 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g76401 );
				float3 lerpResult6225_g76401 = lerp( float3( 1,1,1 ) , (tex2DNode89_g76401).rgb , _SecondAlbedoValue);
				float4 tex2DNode33_g76401 = SAMPLE_TEXTURE2D( _SecondMaskTex, sampler_Linear_Repeat, Second_UVs17_g76401 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half2 Second_UVs_Offset7605_g76401 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76429 = ( ( ( temp_output_30_0_g76581 + temp_output_29_0_g76581 + temp_output_31_0_g76581 ) * lerpResult7614_g76401 ) + Second_UVs_Offset7605_g76401 );
				o.ase_texcoord7.xy = vertexToFrag11_g76429;
				o.ase_texcoord8.xyz = vertexToFrag3890_g76401;
				float4x4 break19_g76459 = GetObjectToWorldMatrix();
				float3 appendResult20_g76459 = (float3(break19_g76459[ 0 ][ 3 ] , break19_g76459[ 1 ][ 3 ] , break19_g76459[ 2 ][ 3 ]));
				float3 appendResult60_g76411 = (float3(v.ase_texcoord3.x , v.ase_texcoord3.z , v.ase_texcoord3.y));
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float2 vertexToFrag11_g76429 = IN.ase_texcoord7.xy;
				half2 Second_UVs17_g76401 = vertexToFrag11_g76429;
				half4 Normal_Packed45_g76562 = SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_Linear_Repeat, Second_UVs17_g76401 );
				float2 appendResult58_g76562 = (float2(( (Normal_Packed45_g76562).x * (Normal_Packed45_g76562).w ) , (Normal_Packed45_g76562).y));
				half2 Normal_Default50_g76562 = appendResult58_g76562;
		...
		Pass
		{
			...
			VertexOutput VertexFunction(VertexInput v  )
			{
				...
				half2 Second_UVs_Offset7605_g76401 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76429 = ( ( ( temp_output_30_0_g76581 + temp_output_29_0_g76581 + temp_output_31_0_g76581 ) * lerpResult7614_g76401 ) + Second_UVs_Offset7605_g76401 );
				o.ase_texcoord1.xy = vertexToFrag11_g76429;
				float3 ase_worldTangent = TransformObjectToWorldDir(v.ase_tangent.xyz);
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 tex2DNode29_g76401 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g76401 );
				half Main_Alpha316_g76401 = tex2DNode29_g76401.a;
				float2 vertexToFrag11_g76429 = IN.ase_texcoord1.xy;
				half2 Second_UVs17_g76401 = vertexToFrag11_g76429;
				float4 tex2DNode89_g76401 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g76401 );
				half Second_Alpha5007_g76401 = tex2DNode89_g76401.a;
				float4 tex2DNode35_g76401 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_Linear_Repeat, Main_UVs15_g76401 );
				...
				float temp_output_7_0_g76456 = TVE_CameraFadeMin;
				float temp_output_10_0_g76456 = ( TVE_CameraFadeMax - temp_output_7_0_g76456 );
				float lerpResult4755_g76401 = lerp( 1.0 , saturate( saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g76456 ) / ( temp_output_10_0_g76456 + 0.0001 ) ) ) ) , _FadeCameraValue);
				half Fade_Camera3743_g76401 = lerpResult4755_g76401;
				half Fade_Effects_B6228_g76401 = ( Fade_Effects_A5360_g76401 * Fade_Camera3743_g76401 );
				float lerpResult6866_g76401 = lerp( ( 1.0 - Blend_Mask147_g76401 ) , 1.0 , _DetailFadeMode);
				#ifdef TVE_FEATURE_DETAIL
...
Node;AmplifyShaderEditor.RangedFloatNode;404;-1408,-768;Half;False;Property;_render_coverage;_render_coverage;251;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;405;-1920,512;Inherit;False;Define Lighting Standard;252;;76275;116a5c57ec750cb4896f729a6748c509;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=1AD65E350C27A43CF933B1CAE9575AB2997736E3