	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 break33_g77084 = _second_uvs_mode;
				float2 temp_output_30_0_g77084 = ( v.texcoord.xy * break33_g77084.x );
				float2 appendResult21_g77079 = (float2(v.texcoord1.z , v.texcoord1.w));
				float2 Mesh_DetailCoord3_g76957 = appendResult21_g77079;
				float2 temp_output_29_0_g77084 = ( Mesh_DetailCoord3_g76957 * break33_g77084.y );
				...
				float2 temp_output_31_0_g77084 = ( (WorldPosition_Shifted7477_g76957).xz * break33_g77084.z );
				...
				float2 vertexToFrag11_g76985 = ( ( ( temp_output_30_0_g77084 + temp_output_29_0_g77084 + temp_output_31_0_g77084 ) * lerpResult7614_g76957 ) + Second_UVs_Offset7605_g76957 );
				o.ase_texcoord9.xy = vertexToFrag11_g76985;
				o.ase_texcoord10.xyz = vertexToFrag3890_g76957;
				float4x4 break19_g77015 = GetObjectToWorldMatrix();
				float3 appendResult20_g77015 = (float3(break19_g77015[ 0 ][ 3 ] , break19_g77015[ 1 ][ 3 ] , break19_g77015[ 2 ][ 3 ]));
				...
				float3 temp_output_122_0_g77015 = Mesh_PivotsData2831_g76957;
				float3 PivotsOnly105_g77015 = (mul( GetObjectToWorldMatrix(), float4( temp_output_122_0_g77015 , 0.0 ) ).xyz).xyz;
				half3 ObjectData20_g77017 = ( appendResult20_g77015 + PivotsOnly105_g77015 );
				half3 WorldData19_g77017 = ase_worldPos;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g77017 = WorldData19_g77017;
				#else
				float3 staticSwitch14_g77017 = ObjectData20_g77017;
				#endif
				float3 temp_output_114_0_g77015 = staticSwitch14_g77017;
				float3 vertexToFrag4224_g76957 = temp_output_114_0_g77015;
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float clampResult17_g77064 = clamp( Main_Mask57_g76957 , 0.0001 , 0.9999 );
				float temp_output_7_0_g77065 = _MainMaskMinValue;
				float temp_output_10_0_g77065 = ( _MainMaskMaxValue - temp_output_7_0_g77065 );
				half Main_Mask_Remap5765_g76957 = saturate( ( ( clampResult17_g77064 - temp_output_7_0_g77065 ) / ( temp_output_10_0_g77065 + 0.0001 ) ) );
				...
				float2 vertexToFrag11_g76985 = IN.ase_texcoord9.xy;
				half2 Second_UVs17_g76957 = vertexToFrag11_g76985;
				...
				float clampResult17_g77067 = clamp( Second_Mask81_g76957 , 0.0001 , 0.9999 );
				float temp_output_7_0_g77068 = _SecondMaskMinValue;
				float temp_output_10_0_g77068 = ( _SecondMaskMaxValue - temp_output_7_0_g77068 );
				half Second_Mask_Remap6130_g76957 = saturate( ( ( clampResult17_g77067 - temp_output_7_0_g77068 ) / ( temp_output_10_0_g77068 + 0.0001 ) ) );
				...
				float staticSwitch1_g77001 = 2.0;
				#else
				float staticSwitch1_g77001 = 4.594794;
				#endif
				float3 lerpResult4834_g76957 = lerp( ( Main_Albedo99_g76957 * Second_Albedo153_g76957 * staticSwitch1_g77001 ) , Second_Albedo153_g76957 , _DetailBlendMode);
				float lerpResult6885_g76957 = lerp( Main_Mask57_g76957 , Second_Mask81_g76957 , _DetailMaskMode);
				float clampResult17_g77037 = clamp( lerpResult6885_g76957 , 0.0001 , 0.9999 );
				float temp_output_7_0_g77036 = _DetailMaskMinValue;
				float temp_output_10_0_g77036 = ( _DetailMaskMaxValue - temp_output_7_0_g77036 );
				half Blend_Mask_Texture6794_g76957 = saturate( ( ( clampResult17_g77037 - temp_output_7_0_g77036 ) / ( temp_output_10_0_g77036 + 0.0001 ) ) );
				half Mesh_DetailMask90_g76957 = IN.ase_color.b;
				half4 Normal_Packed45_g77063 = SAMPLE_TEXTURE2D( _MainNormalTex, sampler_Linear_Repeat, Main_UVs15_g76957 );
				float2 appendResult58_g77063 = (float2(( (Normal_Packed45_g77063).x * (Normal_Packed45_g77063).w ) , (Normal_Packed45_g77063).y));
				half2 Normal_Default50_g77063 = appendResult58_g77063;
				half2 Normal_ASTC41_g77063 = (Normal_Packed45_g77063).xy;
				#ifdef UNITY_ASTC_NORMALMAP_ENCODING
				float2 staticSwitch38_g77063 = Normal_ASTC41_g77063;
				#else
				float2 staticSwitch38_g77063 = Normal_Default50_g77063;
				#endif
				half2 Normal_NO_DTX544_g77063 = (Normal_Packed45_g77063).wy;
				#ifdef UNITY_NO_DXT5nm
				float2 staticSwitch37_g77063 = Normal_NO_DTX544_g77063;
				#else
				float2 staticSwitch37_g77063 = staticSwitch38_g77063;
				#endif
				float2 temp_output_6555_0_g76957 = ( (staticSwitch37_g77063*2.0 + -1.0) * _MainNormalValue );
				...
				float clampResult17_g77035 = clamp( lerpResult6884_g76957 , 0.0001 , 0.9999 );
				float temp_output_7_0_g77034 = _DetailMeshMinValue;
				float temp_output_10_0_g77034 = ( _DetailMeshMaxValue - temp_output_7_0_g77034 );
				half Blend_Mask_Mesh1540_g76957 = saturate( ( ( clampResult17_g77035 - temp_output_7_0_g77034 ) / ( temp_output_10_0_g77034 + 0.0001 ) ) );
				float clampResult17_g77045 = clamp( ( Blend_Mask_Texture6794_g76957 * Blend_Mask_Mesh1540_g76957 ) , 0.0001 , 0.9999 );
				float temp_output_7_0_g77060 = _DetailBlendMinValue;
				float temp_output_10_0_g77060 = ( _DetailBlendMaxValue - temp_output_7_0_g77060 );
				half Blend_Mask147_g76957 = ( saturate( ( ( clampResult17_g77045 - temp_output_7_0_g77060 ) / ( temp_output_10_0_g77060 + 0.0001 ) ) ) * _DetailMode * _DetailValue );
				...
				float clampResult17_g77007 = clamp( Mesh_Occlusion318_g76957 , 0.0001 , 0.9999 );
				float temp_output_7_0_g77013 = _VertexOcclusionMinValue;
				float temp_output_10_0_g77013 = ( _VertexOcclusionMaxValue - temp_output_7_0_g77013 );
				half Occlusion_Mask6432_g76957 = saturate( ( ( clampResult17_g77007 - temp_output_7_0_g77013 ) / ( temp_output_10_0_g77013 + 0.0001 ) ) );
				...
				float3 temp_output_3_0_g77005 = Blend_Albedo_Tinted2808_g76957;
				float dotResult20_g77005 = dot( temp_output_3_0_g77005 , float3(0.2126,0.7152,0.0722) );
				half Blend_Albedo_Grayscale5939_g76957 = dotResult20_g77005;
				float3 temp_cast_1 = (Blend_Albedo_Grayscale5939_g76957).xxx;
				float temp_output_82_0_g76980 = _LayerColorsValue;
				float temp_output_19_0_g76984 = TVE_ColorsUsage[(int)temp_output_82_0_g76980];
				float4 temp_output_91_19_g76980 = TVE_ColorsCoords;
				...
				half2 UV94_g76980 = ( (temp_output_91_19_g76980).zw + ( (temp_output_91_19_g76980).xy * (lerpResult4822_g76957).xz ) );
				float4 tex2DArrayNode83_g76980 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, UV94_g76980,temp_output_82_0_g76980, 0.0 );
				float4 temp_output_17_0_g76984 = tex2DArrayNode83_g76980;
				float4 temp_output_92_86_g76980 = TVE_ColorsParams;
				float4 temp_output_3_0_g76984 = temp_output_92_86_g76980;
				float4 ifLocalVar18_g76984 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g76984 >= 0.5 )
				ifLocalVar18_g76984 = temp_output_17_0_g76984;
				else
				ifLocalVar18_g76984 = temp_output_3_0_g76984;
				float4 lerpResult22_g76984 = lerp( temp_output_3_0_g76984 , temp_output_17_0_g76984 , temp_output_19_0_g76984);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g76984 = lerpResult22_g76984;
				#else
				float4 staticSwitch24_g76984 = ifLocalVar18_g76984;
				#endif
				half4 Global_Colors_Params5434_g76957 = staticSwitch24_g76984;
				...
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g76997 = 2.0;
				#else
				float staticSwitch1_g76997 = 4.594794;
				#endif
				half3 Colors_RGB1954_g76957 = ( Global_Colors_RGB1700_g76957 * staticSwitch1_g76997 * _ColorsIntensityValue );
				...
				half Colors_Value3692_g76957 = ( Blend_Mask_Remap6621_g76957 * _GlobalColors );
				half Colors_Variation3650_g76957 = 1.0;
				half Occlusion_Alpha6463_g76957 = _VertexOcclusionColor.a;
				float lerpResult6459_g76957 = lerp( Occlusion_Mask6432_g76957 , ( 1.0 - Occlusion_Mask6432_g76957 ) , _ColorsMaskMode);
				...
				float3 temp_output_3_0_g77006 = ( Blend_Albedo265_g76957 * Tint_Gradient_Color5769_g76957 * Tint_Noise_Color5770_g76957 );
				float dotResult20_g77006 = dot( temp_output_3_0_g77006 , float3(0.2126,0.7152,0.0722) );
				float clampResult6740_g76957 = clamp( saturate( ( dotResult20_g77006 * 5.0 ) ) , 0.2 , 1.0 );
				half Blend_Albedo_Globals6410_g76957 = clampResult6740_g76957;
				float temp_output_7_0_g77043 = 0.1;
				float temp_output_10_0_g77043 = ( 0.2 - temp_output_7_0_g77043 );
				float lerpResult16_g76998 = lerp( 0.0 , saturate( ( ( ( Colors_Value3692_g76957 * Colors_Influence3668_g76957 * Colors_Variation3650_g76957 * Occlusion_Colors6450_g76957 * Blend_Albedo_Globals6410_g76957 ) - temp_output_7_0_g77043 ) / ( temp_output_10_0_g77043 + 0.0001 ) ) ) , TVE_IsEnabled);
				float3 lerpResult3628_g76957 = lerp( Blend_Albedo_Tinted2808_g76957 , ( lerpResult3618_g76957 * Colors_RGB1954_g76957 ) , lerpResult16_g76998);
				...
				float temp_output_84_0_g76975 = _LayerExtrasValue;
				float temp_output_19_0_g76979 = TVE_ExtrasUsage[(int)temp_output_84_0_g76975];
				float4 temp_output_93_19_g76975 = TVE_ExtrasCoords;
				float3 lerpResult4827_g76957 = lerp( WorldPosition3905_g76957 , ObjectPosition4223_g76957 , _ExtrasPositionMode);
				half2 UV96_g76975 = ( (temp_output_93_19_g76975).zw + ( (temp_output_93_19_g76975).xy * (lerpResult4827_g76957).xz ) );
				float4 tex2DArrayNode48_g76975 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_Linear_Clamp, UV96_g76975,temp_output_84_0_g76975, 0.0 );
				float4 temp_output_17_0_g76979 = tex2DArrayNode48_g76975;
				float4 temp_output_94_85_g76975 = TVE_ExtrasParams;
				float4 temp_output_3_0_g76979 = temp_output_94_85_g76975;
				float4 ifLocalVar18_g76979 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g76979 >= 0.5 )
				ifLocalVar18_g76979 = temp_output_17_0_g76979;
				else
				ifLocalVar18_g76979 = temp_output_3_0_g76979;
				float4 lerpResult22_g76979 = lerp( temp_output_3_0_g76979 , temp_output_17_0_g76979 , temp_output_19_0_g76979);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g76979 = lerpResult22_g76979;
				#else
				float4 staticSwitch24_g76979 = ifLocalVar18_g76979;
				#endif
				half4 Global_Extras_Params5440_g76957 = staticSwitch24_g76979;
				float4 break456_g76989 = Global_Extras_Params5440_g76957;
				half Global_Extras_Overlay156_g76957 = break456_g76989.z;
				...
				half4 Normal_Packed45_g77066 = SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_Linear_Repeat, Second_UVs17_g76957 );
				float2 appendResult58_g77066 = (float2(( (Normal_Packed45_g77066).x * (Normal_Packed45_g77066).w ) , (Normal_Packed45_g77066).y));
				half2 Normal_Default50_g77066 = appendResult58_g77066;
				half2 Normal_ASTC41_g77066 = (Normal_Packed45_g77066).xy;
				#ifdef UNITY_ASTC_NORMALMAP_ENCODING
				float2 staticSwitch38_g77066 = Normal_ASTC41_g77066;
				#else
				float2 staticSwitch38_g77066 = Normal_Default50_g77066;
				#endif
				half2 Normal_NO_DTX544_g77066 = (Normal_Packed45_g77066).wy;
				#ifdef UNITY_NO_DXT5nm
				float2 staticSwitch37_g77066 = Normal_NO_DTX544_g77066;
				#else
				float2 staticSwitch37_g77066 = staticSwitch38_g77066;
				#endif
				float2 temp_output_6560_0_g76957 = ( (staticSwitch37_g77066*2.0 + -1.0) * _SecondNormalValue );
				half2 Normal_Planar45_g77069 = temp_output_6560_0_g76957;
				float2 break64_g77069 = Normal_Planar45_g77069;
				float3 appendResult65_g77069 = (float3(break64_g77069.x , 0.0 , break64_g77069.y));
				float2 temp_output_7603_0_g76957 = (mul( ase_worldToTangent, appendResult65_g77069 )).xy;
				...
				float2 temp_output_36_0_g77002 = ( lerpResult3372_g76957 + Second_Normal179_g76957 );
				float2 lerpResult3376_g76957 = lerp( Main_Normal137_g76957 , temp_output_36_0_g77002 , Blend_Mask147_g76957);
				#ifdef TVE_FEATURE_DETAIL
				...
				float lerpResult6467_g76957 = lerp( Occlusion_Alpha6463_g76957 , 1.0 , Occlusion_Mask6432_g76957);
				half Occlusion_Overlay6471_g76957 = lerpResult6467_g76957;
				float temp_output_7_0_g77011 = 0.1;
				float temp_output_10_0_g77011 = ( 0.2 - temp_output_7_0_g77011 );
				half Overlay_Mask_High6064_g76957 = saturate( ( ( ( Overlay_Value5738_g76957 * Overlay_Projection6081_g76957 * Overlay_Shading6688_g76957 * Overlay_Custom6707_g76957 * Occlusion_Overlay6471_g76957 ) - temp_output_7_0_g77011 ) / ( temp_output_10_0_g77011 + 0.0001 ) ) );
				...
				half Global_Extras_Wetness305_g76957 = break456_g76989.y;
				...
				float3 temp_output_13_0_g76990 = appendResult6568_g76957;
				float3 temp_output_33_0_g76990 = ( temp_output_13_0_g76990 * _render_normals );
				float3 switchResult12_g76990 = (((ase_vface>0)?(temp_output_13_0_g76990):(temp_output_33_0_g76990)));
				...
				float3 temp_cast_12 = (temp_output_7_0_g77085).xxx;
				float temp_output_10_0_g77085 = ( _EmissiveTexMaxValue - temp_output_7_0_g77085 );
				half3 Emissive_Texture7022_g76957 = saturate( ( ( (SAMPLE_TEXTURE2D( _EmissiveTex, sampler_Linear_Repeat, Emissive_UVs2468_g76957 )).rgb - temp_cast_12 ) / ( temp_output_10_0_g77085 + 0.0001 ) ) );
				half Global_Extras_Emissive4203_g76957 = break456_g76989.x;
				...
				float3 temp_output_3_0_g77087 = ( Emissive_Color7162_g76957 * Emissive_Mask6968_g76957 );
				float temp_output_15_0_g77087 = _emissive_intensity_value;
				float3 temp_output_23_0_g77087 = ( temp_output_3_0_g77087 * temp_output_15_0_g77087 );
				#ifdef _TVE_FEATURE_EMISSIVE
				float3 staticSwitch7687_g76957 = temp_output_23_0_g77087;
				#else
				...
				float localCustomAlphaClip19_g77062 = ( 0.0 );
				...
				float temp_output_7_0_g77012 = TVE_CameraFadeMin;
				float temp_output_10_0_g77012 = ( TVE_CameraFadeMax - temp_output_7_0_g77012 );
				float lerpResult4755_g76957 = lerp( 1.0 , saturate( saturate( ( ( distance( WorldPosition , _WorldSpaceCameraPos ) - temp_output_7_0_g77012 ) / ( temp_output_10_0_g77012 + 0.0001 ) ) ) ) , _FadeCameraValue);
				...
				float temp_output_3_0_g77062 = Final_Alpha7344_g76957;
				float Alpha19_g77062 = temp_output_3_0_g77062;
				float temp_output_15_0_g77062 = 0.01;
				float Treshold19_g77062 = temp_output_15_0_g77062;
				{
				...
				clip(Alpha19_g77062 - Treshold19_g77062);
				#endif
				#else
				clip(Alpha19_g77062 - Treshold19_g77062);
				#endif
				...
				half Final_Clip914_g76957 = saturate( ( Alpha19_g77062 * Blend_Color_Alpha6167_g76957 ) );
				...
				float3 Normal = switchResult12_g76990;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float4 break33_g77084 = _second_uvs_mode;
				float2 temp_output_30_0_g77084 = ( v.ase_texcoord.xy * break33_g77084.x );
				float2 appendResult21_g77079 = (float2(v.ase_texcoord1.z , v.ase_texcoord1.w));
				float2 Mesh_DetailCoord3_g76957 = appendResult21_g77079;
				float2 temp_output_29_0_g77084 = ( Mesh_DetailCoord3_g76957 * break33_g77084.y );
				float3 ase_worldPos = TransformObjectToWorld( (v.positionOS).xyz );
				float3 vertexToFrag3890_g76957 = ase_worldPos;
				...
				half2 Second_UVs_Offset7605_g76957 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76985 = ( ( ( temp_output_30_0_g77084 + temp_output_29_0_g77084 + temp_output_31_0_g77084 ) * lerpResult7614_g76957 ) + Second_UVs_Offset7605_g76957 );
				o.ase_texcoord4.xy = vertexToFrag11_g76985;
						 ...
						 ) : SV_TARGET
			{
				...
				float4 tex2DNode29_g76957 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g76957 );
				half Main_Alpha316_g76957 = tex2DNode29_g76957.a;
				float2 vertexToFrag11_g76985 = IN.ase_texcoord4.xy;
				half2 Second_UVs17_g76957 = vertexToFrag11_g76985;
				float4 tex2DNode89_g76957 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g76957 );
				half Second_Alpha5007_g76957 = tex2DNode89_g76957.a;
				float4 tex2DNode35_g76957 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_Linear_Repeat, Main_UVs15_g76957 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 break33_g77084 = _second_uvs_mode;
				float2 temp_output_30_0_g77084 = ( v.texcoord0.xy * break33_g77084.x );
				float2 appendResult21_g77079 = (float2(v.texcoord1.z , v.texcoord1.w));
				float2 Mesh_DetailCoord3_g76957 = appendResult21_g77079;
				float2 temp_output_29_0_g77084 = ( Mesh_DetailCoord3_g76957 * break33_g77084.y );
				float3 ase_worldPos = TransformObjectToWorld( (v.positionOS).xyz );
				...
				half2 Second_UVs_Offset7605_g76957 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76985 = ( ( ( temp_output_30_0_g77084 + temp_output_29_0_g77084 + temp_output_31_0_g77084 ) * lerpResult7614_g76957 ) + Second_UVs_Offset7605_g76957 );
				o.ase_texcoord5.xy = vertexToFrag11_g76985;
				float3 ase_worldTangent = TransformObjectToWorldDir(v.ase_tangent.xyz);
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half3 Main_Color_RGB7657_g76957 = (lerpResult7654_g76957).rgb;
				half3 Main_Albedo99_g76957 = ( lerpResult6223_g76957 * Main_Color_RGB7657_g76957 );
				float2 vertexToFrag11_g76985 = IN.ase_texcoord5.xy;
				half2 Second_UVs17_g76957 = vertexToFrag11_g76985;
				float4 tex2DNode89_g76957 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g76957 );
				float3 lerpResult6225_g76957 = lerp( float3( 1,1,1 ) , (tex2DNode89_g76957).rgb , _SecondAlbedoValue);
				float4 tex2DNode33_g76957 = SAMPLE_TEXTURE2D( _SecondMaskTex, sampler_Linear_Repeat, Second_UVs17_g76957 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half2 Second_UVs_Offset7605_g76957 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76985 = ( ( ( temp_output_30_0_g77084 + temp_output_29_0_g77084 + temp_output_31_0_g77084 ) * lerpResult7614_g76957 ) + Second_UVs_Offset7605_g76957 );
				o.ase_texcoord3.xy = vertexToFrag11_g76985;
				float3 ase_worldTangent = TransformObjectToWorldDir(v.ase_tangent.xyz);
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half3 Main_Color_RGB7657_g76957 = (lerpResult7654_g76957).rgb;
				half3 Main_Albedo99_g76957 = ( lerpResult6223_g76957 * Main_Color_RGB7657_g76957 );
				float2 vertexToFrag11_g76985 = IN.ase_texcoord3.xy;
				half2 Second_UVs17_g76957 = vertexToFrag11_g76985;
				float4 tex2DNode89_g76957 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g76957 );
				float3 lerpResult6225_g76957 = lerp( float3( 1,1,1 ) , (tex2DNode89_g76957).rgb , _SecondAlbedoValue);
				float4 tex2DNode33_g76957 = SAMPLE_TEXTURE2D( _SecondMaskTex, sampler_Linear_Repeat, Second_UVs17_g76957 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half2 Second_UVs_Offset7605_g76957 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76985 = ( ( ( temp_output_30_0_g77084 + temp_output_29_0_g77084 + temp_output_31_0_g77084 ) * lerpResult7614_g76957 ) + Second_UVs_Offset7605_g76957 );
				o.ase_texcoord7.xy = vertexToFrag11_g76985;
				o.ase_texcoord8.xyz = vertexToFrag3890_g76957;
				float4x4 break19_g77015 = GetObjectToWorldMatrix();
				float3 appendResult20_g77015 = (float3(break19_g77015[ 0 ][ 3 ] , break19_g77015[ 1 ][ 3 ] , break19_g77015[ 2 ][ 3 ]));
				float3 appendResult60_g76967 = (float3(v.ase_texcoord3.x , v.ase_texcoord3.z , v.ase_texcoord3.y));
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float2 vertexToFrag11_g76985 = IN.ase_texcoord7.xy;
				half2 Second_UVs17_g76957 = vertexToFrag11_g76985;
				half4 Normal_Packed45_g77066 = SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_Linear_Repeat, Second_UVs17_g76957 );
				float2 appendResult58_g77066 = (float2(( (Normal_Packed45_g77066).x * (Normal_Packed45_g77066).w ) , (Normal_Packed45_g77066).y));
				half2 Normal_Default50_g77066 = appendResult58_g77066;
		...
		Pass
		{
			...
			VertexOutput VertexFunction(VertexInput v  )
			{
				...
				half2 Second_UVs_Offset7605_g76957 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76985 = ( ( ( temp_output_30_0_g77084 + temp_output_29_0_g77084 + temp_output_31_0_g77084 ) * lerpResult7614_g76957 ) + Second_UVs_Offset7605_g76957 );
				o.ase_texcoord1.xy = vertexToFrag11_g76985;
				float3 ase_worldTangent = TransformObjectToWorldDir(v.ase_tangent.xyz);
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 tex2DNode29_g76957 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g76957 );
				half Main_Alpha316_g76957 = tex2DNode29_g76957.a;
				float2 vertexToFrag11_g76985 = IN.ase_texcoord1.xy;
				half2 Second_UVs17_g76957 = vertexToFrag11_g76985;
				float4 tex2DNode89_g76957 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g76957 );
				half Second_Alpha5007_g76957 = tex2DNode89_g76957.a;
				float4 tex2DNode35_g76957 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_Linear_Repeat, Main_UVs15_g76957 );
				...
				float temp_output_7_0_g77012 = TVE_CameraFadeMin;
				float temp_output_10_0_g77012 = ( TVE_CameraFadeMax - temp_output_7_0_g77012 );
				float lerpResult4755_g76957 = lerp( 1.0 , saturate( saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g77012 ) / ( temp_output_10_0_g77012 + 0.0001 ) ) ) ) , _FadeCameraValue);
				half Fade_Camera3743_g76957 = lerpResult4755_g76957;
				half Fade_Effects_B6228_g76957 = ( Fade_Effects_A5360_g76957 * Fade_Camera3743_g76957 );
				float lerpResult6866_g76957 = lerp( ( 1.0 - Blend_Mask147_g76957 ) , 1.0 , _DetailFadeMode);
				#ifdef TVE_FEATURE_DETAIL
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-2176,-768;Half;False;Property;_render_cull;_render_cull;247;1;[HideInInspector];Create;True;0;3;Both;0;Back;1;Front;2;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-1984,-768;Half;False;Property;_render_src;_render_src;248;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;7;-1792,-768;Half;False;Property;_render_dst;_render_dst;249;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-1600,-768;Half;False;Property;_render_zw;_render_zw;250;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;397;-1408,-768;Half;False;Property;_render_coverage;_render_coverage;251;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;813;-1664,512;Inherit;False;Define ShaderType Prop;254;;76747;96e31a47d32deff49ba83d5b364f536d;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;816;-1936,512;Inherit;False;Define Lighting Subsurface;252;;76956;77137addbb4a22f4c818adc8782926be;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;811;-2176,-384;Inherit;False;Base Shader Core;0;;76957;856f7164d1c579d43a5cf4968a75ca43;95,7343,0,3880,1,4028,1,3900,1,3908,1,4172,1,4179,1,6791,1,1298,1,1300,1,6792,1,3586,0,4499,0,1708,1,6056,1,3509,1,3873,0,893,0,6230,0,5156,1,5345,0,7566,1,1718,1,1717,1,1715,1,6116,1,5075,1,1714,1,6076,1,6592,1,6068,1,6692,0,6729,1,1776,0,6378,1,3475,1,6352,1,6655,1,4210,1,1745,0,3479,0,1646,0,3501,0,2807,0,6206,0,7565,0,4999,0,6194,0,3887,0,7321,0,7332,0,3957,1,6647,0,6257,0,5357,0,2172,0,3883,0,3728,1,7650,0,5350,0,2658,0,7617,0,1742,0,3484,0,4837,1,1734,1,1737,1,6161,1,6166,1,1735,1,1736,1,6320,1,6622,1,6848,1,7429,0,7624,0,6721,0,860,0,2260,1,2261,1,2032,1,2054,1,5258,0,2062,1,2039,1,7548,1,7550,1,3243,0,5220,0,4217,1,6699,1,5339,0,5090,1,4242,0,7492,0;10;7333;FLOAT3;1,1,1;False;6196;FLOAT;1;False;6693;FLOAT;1;False;6201;FLOAT;1;False;6205;FLOAT;1;False;7652;FLOAT;1;False;5143;FLOAT;1;False;6231;FLOAT;1;False;6198;FLOAT;1;False;5340;FLOAT3;0,0,0;False;23;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4842;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT;532;FLOAT;5389;FLOAT;721;FLOAT3;1230;FLOAT;5296;FLOAT;1461;FLOAT;1290;FLOAT;629;FLOAT3;534;FLOAT;4867;FLOAT4;5246;FLOAT4;4841
...
ASEEND*/
//CHKSM=E908DD9E20668D743E5A11A65BFC1A448D77F5BC