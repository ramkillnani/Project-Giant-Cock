...
namespace VolumetricLights {
    ...
    public partial class VolumetricLightProfileEditor : Editor {
        ...
        SerializedProperty blendMode, raymarchPreset, raymarchQuality, raymarchMinStep, raymarchMaxSteps, dithering, jittering, useBlueNoise, renderQueue, sortingLayerID, sortingOrder, flipDepthTexture, alwaysOn;
        ...
        SerializedProperty enableShadows, shadowIntensity, shadowResolution, shadowCullingMask, shadowBakeInterval, shadowNearDistance, shadowAutoToggle, shadowDistanceDeactivation, shadowBakeMode, shadowOrientation, shadowDirection;
